...
{
    /**
     * // // // @error suppressionerror suppressionerror suppressionvar string The server activities table name
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array $data Associative array of activity fields
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn int|false The new activity's ID or false on failure
     */
     ...
     * Get activity by ID.
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $id Activity ID
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array|null Activity data or null if not found
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $serverId Server ID
     * // // // @error suppressionerror suppressionerror suppressionparam int $limit Maximum number of results (default: 100)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of activities
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $nodeId Node ID
     * // // // @error suppressionerror suppressionerror suppressionparam int $limit Maximum number of results (default: 100)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of activities
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $event Event type
     * // // // @error suppressionerror suppressionerror suppressionparam int $limit Maximum number of results (default: 100)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of activities
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $userId User ID
     * // // // @error suppressionerror suppressionerror suppressionparam int $limit Maximum number of results (default: 100)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of activities
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam int $limit Maximum number of results (default: 100)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of activities with server details
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam int $perPage Number of results per page
     * // // // @error suppressionerror suppressionerror suppressionparam string $search Search term for event (optional)
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam int|null $userId Filter by user ID (optional)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of activities with pagination info
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $daysOld Number of days old to delete
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn int Number of deleted records
     */
