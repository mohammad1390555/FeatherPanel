...
{
    /**
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionvar array Supported time units and their minute equivalents
     */
    ...
    /**
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionvar string The unique identifier for this cron job
     */
    private string $identifier;

    /**
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionvar int Minutes between executions
     */
    private int $interval;

    /**
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionvar string Path to store last run timestamps
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $identifier Unique identifier for this cron job
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $interval Interval string (e.g., "30M", "1H", "1D")
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows \Exception If interval format is invalid
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam callable $callback Function to execute
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn bool Whether the job was executed
     */
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows \Exception If interval format is invalid
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn int Minutes
     */
