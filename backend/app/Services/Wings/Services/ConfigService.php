...
class ConfigService
{
     ...
     *
     * // // @error suppressionerror suppressionreturn string The raw YAML configuration
     */
     ...
     * }
     *
     * // // @error suppressionerror suppressionparam string $yamlContent The complete YAML configuration content
     * // // @error suppressionerror suppressionparam bool $restart Whether to restart Wings after update (default: false)
     *
     ...
     * }
     *
     * // // @error suppressionerror suppressionparam array $updates Associative array of config paths to values (e.g., ['api.port' => 8443])
     * // // @error suppressionerror suppressionparam bool $restart Whether to restart Wings after update (default: false)
     *
     * // // @error suppressionerror suppressionreturn array The response data
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array The configuration schema
     */
