...
class PlayerStatusService
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array $server Server array with keys: uuid_short, uuid, name, status, ip, port, spell, realm, node_fqdn, node_public_ip
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array|null Player status data or null if the server is unsupported
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $uuidShort The server's short UUID
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array|null Cached player status data or null if unavailable
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int|null $configured The configured polling interval in seconds, or null for default
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn int Effective polling interval in seconds
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam string $uuidShort The server's short UUID
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string Cache key in the format `player_status:{uuidShort}`
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $pollingInterval The effective polling interval in seconds
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn int Cache TTL in minutes
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam string $uuidShort The server's short UUID
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array|null Server data array or null if not found
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $allocationIp The allocation IP from the database
     * // // // @error suppressionerror suppressionerror suppressionparam array $server The server data array (may contain node_fqdn, node_public_ip)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string The resolved IP/hostname to query
     */
