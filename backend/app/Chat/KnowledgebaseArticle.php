...
class KnowledgebaseArticle
{
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $page Page number
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $limit Number of records per page
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $search Search term
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int|null $categoryId Filter by category ID
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string|null $status Filter by status
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam bool|null $pinned Filter by pinned status
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array Array of articles
     */
     ...
     * Get article by ID.
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $id Article ID
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array|null Article data or null if not found
     */
     ...
     * Get article by slug.
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $slug Article slug
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array|null Article data or null if not found
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $categoryId Category ID
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $limit Number of records
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array Array of articles
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $authorId Author ID
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $limit Number of records
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array Array of articles
     */
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam bool|null $pinned Filter by pinned status
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn int Count of articles
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $data Article data
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn int|false The new article's ID or false on failure
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $articles Array of ['id' => int, 'sort_order' => int]
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool True on success, false on failure
     */
