...
class Proxmox
{
    ...
    /** // // // @error suppressionerror suppressionerror suppressionvar array<string, string> */
    private array $defaultExtraHeaders;
    /** // // // @error suppressionerror suppressionerror suppressionvar array<string, string|int|float> */
    private array $defaultExtraQuery;

    /**
     * // // // @error suppressionerror suppressionerror suppressionparam string $host Proxmox hostname or IP
     * // // // @error suppressionerror suppressionerror suppressionparam int $port Proxmox API port (default 8006, or 443 if proxied)
     * // // // @error suppressionerror suppressionerror suppressionparam string $scheme http or https
     * // // // @error suppressionerror suppressionerror suppressionparam string $user Proxmox user, e.g. root// // // @error suppressionerror suppressionerror suppressionpam or apiuser// // // @error suppressionerror suppressionerror suppressionpve
     * // // // @error suppressionerror suppressionerror suppressionparam string $tokenId Token ID (part after user, before = in PVEAPIToken)
     * // // // @error suppressionerror suppressionerror suppressionparam string $secret Token secret
     * // // // @error suppressionerror suppressionerror suppressionparam bool $tlsNoVerify Whether to skip TLS verification
     * // // // @error suppressionerror suppressionerror suppressionparam int $timeout Timeout in seconds
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, string> $defaultExtraHeaders Default extra headers to send with every request (e.g. X-Forwarded-For)
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, string|int|float> $defaultExtraQuery Default extra query parameters to send with every request
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, data: array<string, mixed>|null, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, nodes: array<int, mixed>, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $node Proxmox node name (e.g. pve)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, bridges: array<int, string>, error: string|null}
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam string $node Proxmox node name (e.g. pve)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, storage: array<int, string>, error: string|null}
     */
     ...
     * - content=iso
     * - filename=// // // @error suppressionerror suppressionerror suppression<file>
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $node Proxmox node name
     * // // // @error suppressionerror suppressionerror suppressionparam string $storage Proxmox storage name
     * // // // @error suppressionerror suppressionerror suppressionparam string $filePath local filesystem path to the ISO file
     * // // // @error suppressionerror suppressionerror suppressionparam string $filename ISO filename (as it should appear in Proxmox)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, volid: string|null, error: string|null}
     */
    public function uploadIsoToStorage(string $node, string $storage, string $filePath, string $filename): array
    {
        ...
        try {
            $mime = function_exists('mime_content_type') ? (string) // // // @error suppressionerror suppressionerror suppressionmime_content_type($filePath) : '';
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, size: int|null, filename: string|null, mimetype: string|null, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, upid: string|null, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, string> $extraHeaders additional headers to send for this check
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, string|int|float> $extraQuery additional query parameters to send
     *
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $path e.g. /api2/json/cluster/nextid
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, string|int> $query
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, data: mixed, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $path e.g. /api2/json/nodes/pve/qemu/100/clone
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, mixed> $body
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, data: mixed, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $path e.g. /api2/json/nodes/pve/lxc/100/config
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, mixed> $body Form params (delete, net0, memory, etc.)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, data: mixed, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $path e.g. /api2/json/nodes/pve/qemu/100
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, string|int> $query
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, data: mixed, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, vmid: int|null, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $node Proxmox node name (e.g. pve)
     * // // // @error suppressionerror suppressionerror suppressionparam int $templateVmid Template VMID
     * // // // @error suppressionerror suppressionerror suppressionparam int $newid New VM ID
     * // // // @error suppressionerror suppressionerror suppressionparam string $name New VM name
     * // // // @error suppressionerror suppressionerror suppressionparam string|null $target Target node (default same as node)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, upid: string|null, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $node Proxmox node name where the template lives
     * // // // @error suppressionerror suppressionerror suppressionparam int $templateVmid Template container VMID
     * // // // @error suppressionerror suppressionerror suppressionparam int $newid New container VMID
     * // // // @error suppressionerror suppressionerror suppressionparam string $hostname New container hostname
     * // // // @error suppressionerror suppressionerror suppressionparam string|null $target Target node (default same as node)
     * // // // @error suppressionerror suppressionerror suppressionparam string|null $storage Target storage for full clone (e.g. local); required for full clone
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, upid: string|null, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, status: string|null, exitstatus: string|null, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $maxWaitSec Max seconds to wait
     * // // // @error suppressionerror suppressionerror suppressionparam int $intervalSec Seconds between polls
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, config: array<string, mixed>|null, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $node Proxmox node name
     * // // // @error suppressionerror suppressionerror suppressionparam int $vmid VMID
     * // // // @error suppressionerror suppressionerror suppressionparam 'qemu'|'lxc' $vmType
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, status: array<string, mixed>|null, error: string|null}
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam 'qemu'|'lxc' $vmType
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, ticket: string|null, port: int|null, cert: string|null, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, ticket: string|null, csrf: string|null, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, users: array<int, array<string, mixed>>, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int|null $expire Unix timestamp when the user expires (optional)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, mixed> $config Keys as Proxmox expects (memory, sockets, cores, ipconfig0, net0, etc.)
     * // // // @error suppressionerror suppressionerror suppressionparam array<int, string> $deleteKeys Optional keys to remove from config (e.g. ['net0'] to purge template IP)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array<int, string> $ids e.g. ['scsi1'] or ['unused0']
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, node: string|null, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, storages: array<int, string>, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, backups: array<int, mixed>, storages: array<int, string>, error: string|null}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{ok: bool, vms: array<int, array{vmid: int, name: string, node: string, template: int, type: string}>, error: string|null}
     */
