...
class Ticket
{
     ...
     * // @error suppressionparam int|null $serverId Filter by server ID
     * // @error suppressionparam int|null $categoryId Filter by category ID
     * // @error suppressionparam int|null $statusId Filter by status ID
     *
     * // @error suppressionreturn array Array of tickets
     */
     ...
     * Get ticket by ID.
     *
     * // @error suppressionparam int $id Ticket ID
     *
     * // @error suppressionreturn array|null Ticket data or null if not found
     */
     ...
     * Get ticket by UUID.
     *
     * // @error suppressionparam string $uuid Ticket UUID
     *
     * // @error suppressionreturn array|null Ticket data or null if not found
     */
     ...
     *
     * // @error suppressionparam string|null $search Search term
     * // @error suppressionparam string|null $userUuid Filter by user UUID
     * // @error suppressionparam int|null $serverId Filter by server ID
     * // @error suppressionparam int|null $categoryId Filter by category ID
     * // @error suppressionparam int|null $statusId Filter by status ID
     *
     * // @error suppressionreturn int Count of tickets
     */
     ...
     *
     * // @error suppressionreturn int Count of open tickets
     */
     ...
     * Create a new ticket.
     *
     * // @error suppressionparam array $data Ticket data
     *
     * // @error suppressionreturn int|false The new ticket's ID or false on failure
     */
