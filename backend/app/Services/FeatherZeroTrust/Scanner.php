...
class Scanner
{
     ...
     *
     * // @error suppressionparam Wings $wings Wings client instance
     * // @error suppressionparam Configuration|null $config Configuration instance (optional)
     */
     ...
     * // @error suppressionparam string $directory Starting directory (default: '/')
     * // @error suppressionparam int $maxDepth Maximum directory depth (default: 10)
     *
     * // @error suppressionreturn array<string, mixed> Scan results
     */
     ...
     *
     * // @error suppressionparam string $serverUuid Server UUID
     * // @error suppressionparam string $directory Directory path
     * // @error suppressionparam int $maxDepth Maximum depth
     * // @error suppressionparam int $currentDepth Current depth
     * // @error suppressionparam array<string, mixed> $detections Detections array (by reference)
     * // @error suppressionparam array<string, mixed> $errors Errors array (by reference)
     * // @error suppressionparam array<string, mixed> $confirmedHashes Confirmed malicious hashes
     */
     ...
     *
     * // @error suppressionparam string $serverUuid Server UUID
     * // @error suppressionparam string $filePath File path
     *
     * // @error suppressionreturn string File content
     */
     ...
     * // @error suppressionparam string $detectionType Detection type
     * // @error suppressionparam string $filePath File path
     * // @error suppressionparam int $fileSize File size
     */
     ...
     *
     * // @error suppressionreturn array<string, mixed> Hash map of confirmed hashes
     */
