...
class ServerFastDlController
{
    ...
    public function enableFastDl(Request $request, int $serverId): Response
    {
        ...
        try {
            ...
            /** // // // // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionvar array<string,mixed> $responseData */
