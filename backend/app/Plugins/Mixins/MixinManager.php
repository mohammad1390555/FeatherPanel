...
class MixinManager
{
    /** // // // // @error suppressionerror suppressionerror suppressionerror suppressionvar array Registered mixins by identifier */
    private static array $registeredMixins = [];

    /** // // // // @error suppressionerror suppressionerror suppressionerror suppressionvar array Mixin instances by plugin identifier and mixin identifier */
    private static array $mixinInstances = [];

    /**
     * Register a mixin class.
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $mixinClass The fully qualified class name of the mixin
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool True if registered successfully, false otherwise
     */
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $mixinIdentifier The mixin identifier
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $config Optional configuration for the mixin
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn AppMixin|null The mixin instance or null if not found/valid
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array List of mixin identifiers
     */
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $pluginIdentifier The plugin identifier
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array Loaded mixin instances
     */
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $pluginIdentifier The plugin identifier
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array Mixin instances associated with the plugin
     */
