...
final class BackupFifoEviction
{
    ...
    /**
     * // @error suppressionparam mixed $value DB value or API payload (null / empty / inherit => no override)
     *
     * // @error suppressionreturn self::MODE_HARD_LIMIT|self::MODE_FIFO_ROLLING|null
     */
    ...
    /**
     * // @error suppressionparam array<string, mixed> $server Row from featherpanel_servers
     *
    ...
    /**
     * // @error suppressionparam array<string, mixed> $instance Row from featherpanel_vm_instances
     *
     * // @error suppressionreturn array{
     *   panel_backup_retention_mode: string,
     *   backup_retention_mode_override: string|null,
     ...
     *
     * // @error suppressionreturn array{message: string, code: string, status: int}|null
     */
     ...
     *
     * // @error suppressionparam array<string, mixed> $instance VM instance row (needs id, pve_node)
     *
     * // @error suppressionreturn array{message: string, code: string, status: int}|null
     */
