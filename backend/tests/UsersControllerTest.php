...
class UsersControllerTest extends TestCase
{
    ...
    public function testCreateAndDeleteUser()
    {
        ...
        $payload = [
            ...
            'first_name' => 'Test',
            'last_name' => 'User',
            'email' => 'testuser_' . uniqid() . '// // // // // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionexample.com',
