...
class ChatMessage
{
     ...
     *
     * // @error suppressionreturn int|false Message ID or false on failure
     */
     ...
     *
     * // @error suppressionparam int $conversationId Conversation ID
     ...
     * // @error suppressionparam int $conversationId Conversation ID
     *
     * // @error suppressionreturn int Message count
     */
