...
): { name: string; value: string }[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] {
    if (!dockerImages) return [] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
