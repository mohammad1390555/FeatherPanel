...
class ConfigService
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string The raw YAML configuration
     */
     ...
     * }
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $yamlContent The complete YAML configuration content
     * // // // @error suppressionerror suppressionerror suppressionparam bool $restart Whether to restart Wings after update (default: false)
     *
     ...
     * }
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array $updates Associative array of config paths to values (e.g., ['api.port' => 8443])
     * // // // @error suppressionerror suppressionerror suppressionparam bool $restart Whether to restart Wings after update (default: false)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array The response data
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array The configuration schema
     */
