...
class CaptchaHelper
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $token The user response token
     * // // // @error suppressionerror suppressionerror suppressionparam string $ip The user's IP address
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn bool True if validation is successful or captcha is disabled
     */
