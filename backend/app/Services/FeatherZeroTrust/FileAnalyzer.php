...
class FileAnalyzer
{
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam int $fileSize File size in bytes
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{isSuspicious: bool, reason: string, detectionType: string}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $content File content
     * // // // @error suppressionerror suppressionerror suppressionparam string $fileName File name
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{isSuspicious: bool, reason: string, detectionType: string}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $pattern Pattern string
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string Regex pattern
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $pattern Pattern that matched
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string Detection type
     */
