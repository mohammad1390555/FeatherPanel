...
class Allocation
{
     ...
     *
     * // @error suppressionparam array<int> $excludeIds Allocation IDs to skip (already reserved in the same batch)
     *
     * // @error suppressionreturn array<int>
     */
    /**
     * Pick free allocation IDs that match specific IP/port slots (in order).
     *
     * // @error suppressionparam array<int, array{ip: string, port: int}> $slots
     ...
     *
     * // @error suppressionparam array $allocationIds Array of allocation IDs to unassign
     *
     * // @error suppressionreturn bool True if all allocations were unassigned successfully
     */
     ...
     *
     * // @error suppressionparam int $serverId The server ID to assign allocations to
     * // @error suppressionparam array $allocationIds Array of allocation IDs to assign
     *
     * // @error suppressionreturn bool True if all allocations were assigned successfully
     */
     ...
     *
     * // @error suppressionparam int $id Allocation ID
     *
     * // @error suppressionreturn bool True if allocation can be deleted
     */
     ...
     *
     * // @error suppressionparam array $ids Array of allocation IDs to delete
     *
     * // @error suppressionreturn array ['deleted' => count, 'skipped' => count, 'skipped_ids' => []]
     */
     ...
     *
     * // @error suppressionparam int|null $nodeId Optional node ID to filter deletions
     * // @error suppressionparam string|null $ip Optional IP address to filter deletions by subnet/IP
     *
     * // @error suppressionreturn int Number of allocations deleted
     */
