...
{
    /**
     * // // @error suppressionerror suppressionvar string The server_schedules table name
     */
     ...
     *
     * // // @error suppressionerror suppressionparam array $data Associative array of schedule fields
     *
     * // // @error suppressionerror suppressionreturn int|false The new schedule's ID or false on failure
     */
     ...
     * {// // @error suppressionerror suppressionsee calculateNextRunTime()}, so this query is timezone-deterministic
     ...
     * // // @error suppressionerror suppressionparam string $search Search term for name (optional)
     * // // @error suppressionerror suppressionparam array $fields Fields to select (e.g. ['name', 'is_active']) (default: all)
     ...
     * // // @error suppressionerror suppressionparam bool|null $isActive Filter by active status (optional)
     * // // @error suppressionerror suppressionparam bool|null $isProcessing Filter by processing status (optional)
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $dayOfWeek Cron expression day of week component
     * // // @error suppressionerror suppressionparam string $month Cron expression month component
     * // // @error suppressionerror suppressionparam string $dayOfMonth Cron expression day of month component
     * // // @error suppressionerror suppressionparam string $hour Cron expression hour component
     * // // @error suppressionerror suppressionparam string $minute Cron expression minute component
     * // // @error suppressionerror suppressionparam string|null $referenceTime Optional reference time (UTC literal) to maintain cadence
     * // // @error suppressionerror suppressionparam string $timezone IANA timezone name the cron expression is authored in (default: UTC)
     */
