...
class CaptchaHelper
{
     ...
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $token The user response token
     ...
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn bool True if validation is successful or captcha is disabled
     */
