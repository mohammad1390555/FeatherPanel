...
class WingsTransferStatusController
{
     ...
     *
     * // @error suppressionparam array $server The server data
     * // @error suppressionparam array $transfer The transfer record
     * // @error suppressionparam mixed $logger The logger instance
     */
