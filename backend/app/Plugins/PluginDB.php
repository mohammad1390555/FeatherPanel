...
/**
 * // // @error suppressionerror suppressiondeprecated Please use PluginHelper or PluginManager instead!
 */
class PluginDB extends Database
{
     ...
     * Get all the plugins.
     *
     * // // @error suppressionerror suppressiondeprecated Please use PluginManager::getLoadedPlugins() instead
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $name The unique name/identifier of the plugin
     * // // @error suppressionerror suppressionparam string $displayName The display name of the plugin
     *
     * // // @error suppressionerror suppressionreturn bool True if registration successful, false if already exists
     *
     * // // @error suppressionerror suppressiondeprecated Use PluginHelper::getPluginConfig() instead
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $name The name of the plugin
     *
     * // // @error suppressionerror suppressionreturn bool True if plugin exists and isn't deleted
     *
     * // // @error suppressionerror suppressiondeprecated Use PluginHelper::getPluginConfig() instead
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $name The name of the plugin
     * // // @error suppressionerror suppressionparam bool $enabled Whether to enable or disable the plugin
     *
     * // // @error suppressionerror suppressiondeprecated Use PluginHelper::getPluginConfig() instead
     */
     ...
     * // // @error suppressionerror suppressionparam string $name The name of the plugin
     *
     * // // @error suppressionerror suppressionreturn bool True if plugin is enabled
     *
     * // // @error suppressionerror suppressiondeprecated Use PluginHelper::getPluginConfig() instead
     */
     ...
     * // // @error suppressionerror suppressionparam string $name The name of the plugin
     *
     * // // @error suppressionerror suppressionreturn array|null Plugin information or null if not found
     *
     * // // @error suppressionerror suppressiondeprecated Use PluginHelper::getPluginConfig() instead
     */
     ...
     *
     * // // @error suppressionerror suppressionparam bool $includeDisabled Whether to include disabled plugins
     *
     * // // @error suppressionerror suppressionreturn array List of plugins
     *
     * // // @error suppressionerror suppressiondeprecated Use PluginHelper::getPluginConfig() instead
     */
     ...
     *
     * // // @error suppressionerror suppressionparam int $id The ID to convert
     *
     * // // @error suppressionerror suppressionreturn string The name
     *
     * // // @error suppressionerror suppressiondeprecated Use PluginHelper::getPluginConfig() instead
     */
