...
{
    /**
     * // @error suppressionvar string The VM nodes table name
     */
     ...
     *
     * // @error suppressionvar array<int, string>
     */
     ...
     * // @error suppressionparam array<int, string> $requiredFields
     *
     * // @error suppressionreturn array<int, string> Validation error messages (empty if ok)
     */
     ...
     * // @error suppressionparam array<string, mixed> $data
     *
     * // @error suppressionreturn int|false The new VM node ID or false on failure
     */
     ...
     *
     * // @error suppressionparam array<string, mixed> $conditions
     */
