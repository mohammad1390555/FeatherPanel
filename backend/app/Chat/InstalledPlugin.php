...
class InstalledPlugin
{
     ...
     *
     * // // @error suppressionerror suppressionparam array $data Associative array of plugin fields
     *
     * // // @error suppressionerror suppressionreturn int|false The new record's ID or false on failure
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $identifier Plugin identifier
     *
     * // // @error suppressionerror suppressionreturn array|null Plugin data or null if not found
     */
     ...
     *
     * // // @error suppressionerror suppressionparam int $id Plugin record ID
     *
     * // // @error suppressionerror suppressionreturn array|null Plugin data or null if not found
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array Array of installed plugins
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array Array of all plugin records
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array Array of uninstalled plugins
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn int Count of installed plugins
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn int Count of uninstalled plugins
     */
