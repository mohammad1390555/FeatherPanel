...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'user', type: 'string', description: 'Proxmox API user (e.g. root// // // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionpam)'),
