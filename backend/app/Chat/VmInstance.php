...
class VmInstance
{
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array<int, mixed>
     */
    ...
    /**
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam \PDO|null $pdo Optional connection (e.g. when inside a transaction)
     */
