...
class LogHelper
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $type Log type ('web', 'app', etc.)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string Full path to the log file
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $type Log type ('web', 'app', 'mail', 'runner', …)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string Full path to the (now-guaranteed) log file
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $filePath Path to the log file
     * // // // @error suppressionerror suppressionerror suppressionparam int $lines Number of lines to read from the end
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string Content of the last N lines
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $content Log content to upload
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Upload result with 'success', 'url', 'raw', 'id' or 'error'
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $filename The log filename
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string Log type ('web', 'app', or 'unknown')
     */
