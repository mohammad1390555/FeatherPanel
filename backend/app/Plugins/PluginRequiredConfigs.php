...
class PluginRequiredConfigs
{
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array The required configs
     */
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $identifier The plugin identifier
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool True if all required configs are set
     */
