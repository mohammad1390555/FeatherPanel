...
class GameServerQuery
{
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $gameType FeatherPanel game type identifier (e.g., 'minecraft', 'cs2', 'rust')
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $host Server IP/hostname
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $port Server game port
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $timeout Query timeout in seconds (default 5)
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array|null Normalized response or null on failure
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $gameType FeatherPanel game type identifier
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionthrows \InvalidArgumentException If the game type is not supported
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn string GameQ protocol identifier
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $result Raw GameQ result array for a server
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $gameType FeatherPanel game type identifier
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array Normalized response with keys: name, map, max_players, player_count, players, connect
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $host Server IP/hostname
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $port Server port (game port)
    ...
    {
        try {
            $socket = // // // // @error suppressionerror suppressionerror suppressionerror suppressionfsockopen($host, $port, $errno, $errstr, $timeout);
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $host Server IP/hostname
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $port Server port
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $timeout Timeout in seconds
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array|null Normalized response or null on failure
     */
    ...
    {
        try {
            $socket = // // // // @error suppressionerror suppressionerror suppressionerror suppressionfsockopen('udp://' . $host, $port, $errno, $errstr, $timeout);
