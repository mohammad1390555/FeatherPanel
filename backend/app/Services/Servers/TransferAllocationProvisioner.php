...
{
    /**
     * // // @error suppressionerror suppressionparam array<string, mixed> $destinationNode
     * // // @error suppressionerror suppressionparam array<int, array<string, mixed>> $sourceAllocations
     *
     * // // @error suppressionerror suppressionreturn array{success: bool, created: int, error?: string, code?: string, http_status?: int}
     */
    ...
    /**
     * // // @error suppressionerror suppressionparam array<int, array{ip: string, port: int}> $resolvedSlots
     *
     * // // @error suppressionerror suppressionreturn array{success: bool, created: int, error?: string, code?: string, http_status?: int}
     */
    ...
    /**
     * // // @error suppressionerror suppressionparam array<int, array<string, mixed>> $sourceAllocations
     * // // @error suppressionerror suppressionparam array<int, string> $wingsIps
     * // // @error suppressionerror suppressionparam array<string, mixed> $destinationNode
     *
     * // // @error suppressionerror suppressionreturn array<int, array{ip: string, port: int}>
     */
     ...
     * // // @error suppressionerror suppressionparam array<string, mixed> $destinationNode
     *
     * // // @error suppressionerror suppressionreturn array{success: bool, ips?: array<int, string>, error?: string, code?: string, http_status?: int}
     */
    ...
    /**
     * // // @error suppressionerror suppressionparam array<string, mixed> $ipsResponse
     *
     * // // @error suppressionerror suppressionreturn array<int, string>
     */
