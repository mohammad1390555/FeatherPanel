...
{
    /**
     * // @error suppressionvar string The server_schedules table name
     */
     ...
     *
     * // @error suppressionparam array $data Associative array of schedule fields
     *
     * // @error suppressionreturn int|false The new schedule's ID or false on failure
     */
     ...
     * {// @error suppressionsee calculateNextRunTime()}, so this query is timezone-deterministic
     ...
     * // @error suppressionparam string $search Search term for name (optional)
     * // @error suppressionparam array $fields Fields to select (e.g. ['name', 'is_active']) (default: all)
     ...
     * // @error suppressionparam bool|null $isActive Filter by active status (optional)
     * // @error suppressionparam bool|null $isProcessing Filter by processing status (optional)
     */
     ...
     *
     * // @error suppressionparam string $dayOfWeek Cron expression day of week component
     * // @error suppressionparam string $month Cron expression month component
     * // @error suppressionparam string $dayOfMonth Cron expression day of month component
     * // @error suppressionparam string $hour Cron expression hour component
     * // @error suppressionparam string $minute Cron expression minute component
     * // @error suppressionparam string|null $referenceTime Optional reference time (UTC literal) to maintain cadence
     * // @error suppressionparam string $timezone IANA timezone name the cron expression is authored in (default: UTC)
     */
