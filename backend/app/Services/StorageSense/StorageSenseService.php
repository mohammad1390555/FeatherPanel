...
{
    /** // // // @error suppressionerror suppressionerror suppressionvar array<string, bool> */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{path: string, bytes: int}
     */
    ...
    /**
     * // // // @error suppressionerror suppressionerror suppressionreturn array{deleted: int}|null null if target unknown / table missing
     */
    ...
    /**
     * // // // @error suppressionerror suppressionerror suppressionparam string[] $targets
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array<int, array{target: string, deleted: int, success: bool, error?: string}>
     */
    ...
    /**
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, mixed> $params
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{deleted: int}|null
     */
