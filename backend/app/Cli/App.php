...
class App extends Utils\MinecraftColorCodeSupport
{
     ...
     *
     * // // @error suppressionerror suppressionparam string $commandName the name of the command to register
     * // // @error suppressionerror suppressionparam array $args The command arguments
     */
     ...
     * // // @error suppressionerror suppressionparam array $args The command arguments
     *
     * // // @error suppressionerror suppressionreturn bool WhethregisterBuiltInCommandser a plugin command was found and executed
     */
