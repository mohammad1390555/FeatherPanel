...
class RateLimitConfig
{
     ...
     *
     * // @error suppressionreturn string The absolute path to the config file
     */
     ...
     *
     * // @error suppressionreturn bool True if rate limiting is globally enabled
     */
     ...
     *
     * // @error suppressionparam string $routeName The name of the route
     * // @error suppressionparam Rate|null $defaultRate The default rate limit (ignored - only used for auto-population)
     * // @error suppressionparam string|null $defaultNamespace The default namespace if not configured (optional)
     *
     * // @error suppressionreturn array|null Returns ['rate' => Rate, 'namespace' => string] or null if not configured/enabled
     */
     ...
     *
     * // @error suppressionreturn bool True if route exists in config
     */
     ...
     *
     * // @error suppressionparam Rate $rate The Rate object
     *
     * // @error suppressionreturn array|null Returns config array or null if invalid
     */
     ...
     *
     * // @error suppressionparam string $routeName The name of the route
     * // @error suppressionparam Rate $defaultRate The default rate limit to use if not configured
     * // @error suppressionparam string|null $defaultNamespace The default namespace
     *
     * // @error suppressionreturn array Returns ['rate' => Rate, 'namespace' => string]
     */
     ...
     *
     * // @error suppressionreturn array All route rate limit configurations
     */
     ...
     *
     * // @error suppressionparam string $routeName The route name
     * // @error suppressionparam array $config The configuration array
     *
     * // @error suppressionreturn bool True if successful
     */
     ...
     *
     * // @error suppressionreturn array The configuration array
     */
     ...
     *
     * // @error suppressionparam array $config The route configuration
     *
     * // @error suppressionreturn Rate|null The Rate object or null if invalid
     */
