...
trait PropertyAccessor
{
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $property The property name
     *
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $property The property name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam mixed $value The value to assign
     *
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $property The property name
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool Whether the property is set
     */
