...
class ServerService
{
     ...
     * Get server logs.
     *
     * // @error suppressionparam int $lines Number of lines to get (default: 100)
     */
     ...
     *
     * // @error suppressionparam bool $includeDirectorySizes when true, requests Wings recursive per-folder sizes (cached on the daemon)
     */
     ...
     *
     * // @error suppressionparam array<string,mixed> $filters
     */
     ...
     *
     * // @error suppressionparam string $innerPath Path inside the archive (empty string = root)
     */
     ...
     *
     * // @error suppressionparam array<string, mixed> $options Optional keys: use_trash (bool), permanent (bool), trash (array{max_size_bytes?: int, retention_days?: int})
     */
     ...
     * // @error suppressionparam string $root The root directory path
     * // @error suppressionparam array $files Array of file names (relative to root)
     * // @error suppressionparam string $name Optional archive name (empty for auto-generated)
     * // @error suppressionparam string $extension Archive extension (zip, tar.gz, tgz, tar.bz2, tbz2, tar.xz, txz)
     * // @error suppressionparam int|null $timeout Optional timeout in seconds (default: 15 minutes for large archives)
     */
     ...
     *
     * // @error suppressionparam string $serverUuid The server UUID
     * // @error suppressionparam string $file The archive file path
     * // @error suppressionparam string $root The root directory path
     * // @error suppressionparam int|null $timeout Optional timeout in seconds (default: 15 minutes for large archives)
     */
     ...
     *
     * // @error suppressionparam array<int, string> $entries Paths inside the archive (files and/or directories)
     */
     ...
     *
     * // @error suppressiondeprecated Use deAuthUser instead
     */
     ...
     *
     * // @error suppressionparam string $user The user to deauthorize
     * // @error suppressionparam string $serverUuid The server UUID
     */
     ...
     *
     * // @error suppressionparam array<string,mixed> $data Import configuration data
     */
     ...
     *
     * // @error suppressionparam array<string,mixed> $data FastDL configuration data (optional directory)
     */
     ...
     *
     * // @error suppressionparam array<string,mixed> $data FastDL configuration data
     */
