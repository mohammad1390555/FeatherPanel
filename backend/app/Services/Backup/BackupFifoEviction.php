...
final class BackupFifoEviction
{
    ...
    /**
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam mixed $value DB value or API payload (null / empty / inherit => no override)
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn self::MODE_HARD_LIMIT|self::MODE_FIFO_ROLLING|null
     */
    ...
    /**
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array<string, mixed> $server Row from featherpanel_servers
     *
    ...
    /**
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array<string, mixed> $instance Row from featherpanel_vm_instances
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array{
     *   panel_backup_retention_mode: string,
     *   backup_retention_mode_override: string|null,
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array{message: string, code: string, status: int}|null
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array<string, mixed> $instance VM instance row (needs id, pve_node)
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array{message: string, code: string, status: int}|null
     */
