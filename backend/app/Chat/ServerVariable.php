...
{
    /**
     * // // @error suppressionerror suppressionvar string The server_variables table name
     */
     ...
     *
     * // // @error suppressionerror suppressionparam array $data Associative array of server variable fields
     *
     * // // @error suppressionerror suppressionreturn int|false The new server variable's ID or false on failure
     */
     ...
     *
     * // // @error suppressionerror suppressionparam int $id The server variable ID
     *
     * // // @error suppressionerror suppressionreturn array|null The server variable data or null if not found
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array Array of server variables
     */
     ...
     * // // @error suppressionerror suppressionparam int $serverId The server ID
     *
     * // // @error suppressionerror suppressionreturn array Array of server variables with spell variable details
     */
     ...
     *
     * // // @error suppressionerror suppressionparam int $id The server variable ID
     * // // @error suppressionerror suppressionparam array $data The data to update
     *
     ...
     *
     * // // @error suppressionerror suppressionparam int $serverId The server ID
     * // // @error suppressionerror suppressionparam array $variables Array of variables with variable_id and variable_value
     * // // @error suppressionerror suppressionparam \PDO|null $externalPdo When provided and already in a transaction, run without nested begin/commit
     *
     * // // @error suppressionerror suppressionreturn bool True on success, false on failure
     */
     ...
     * // // @error suppressionerror suppressionparam int $serverId The server ID
     *
     * // // @error suppressionerror suppressionreturn int The count
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array Array of all server variables
     */
