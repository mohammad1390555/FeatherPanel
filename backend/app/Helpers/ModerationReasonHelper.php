...
class ModerationReasonHelper
{
    ...
    /**
     * // // @error suppressionerror suppressionreturn array{reason:string,category:?string,details:string}|null
     */
    ...
    /**
     * // // @error suppressionerror suppressionreturn array<string, null>
     */
    ...
    /**
     * // // @error suppressionerror suppressionreturn array<string, int|string|null>
     */
