...
class LogParser
{
     ...
     *
     * // // @error suppressionerror suppressionparam string $gameType The game type identifier (e.g., 'minecraft', 'cs2')
     *
     * // // @error suppressionerror suppressionreturn array Associative array with keys 'join', 'leave', 'stop' containing regex patterns
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $line The log line to parse
     * // // @error suppressionerror suppressionparam string $gameType The game type identifier
     *
     * // // @error suppressionerror suppressionreturn array|null Returns ['event' => 'join'|'leave'|'stop', 'player' => '...'] or null if no match
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $serverUuid The server UUID used as the cache key identifier
     * // // @error suppressionerror suppressionparam string $line The log line to process
     * // // @error suppressionerror suppressionparam string $gameType The game type identifier
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array List of player names currently online
     */
