...
class RateLimitConfig
{
     ...
     *
     * // // @error suppressionerror suppressionreturn string The absolute path to the config file
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn bool True if rate limiting is globally enabled
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $routeName The name of the route
     * // // @error suppressionerror suppressionparam Rate|null $defaultRate The default rate limit (ignored - only used for auto-population)
     * // // @error suppressionerror suppressionparam string|null $defaultNamespace The default namespace if not configured (optional)
     *
     * // // @error suppressionerror suppressionreturn array|null Returns ['rate' => Rate, 'namespace' => string] or null if not configured/enabled
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn bool True if route exists in config
     */
     ...
     *
     * // // @error suppressionerror suppressionparam Rate $rate The Rate object
     *
     * // // @error suppressionerror suppressionreturn array|null Returns config array or null if invalid
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $routeName The name of the route
     * // // @error suppressionerror suppressionparam Rate $defaultRate The default rate limit to use if not configured
     * // // @error suppressionerror suppressionparam string|null $defaultNamespace The default namespace
     *
     * // // @error suppressionerror suppressionreturn array Returns ['rate' => Rate, 'namespace' => string]
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array All route rate limit configurations
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $routeName The route name
     * // // @error suppressionerror suppressionparam array $config The configuration array
     *
     * // // @error suppressionerror suppressionreturn bool True if successful
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array The configuration array
     */
     ...
     *
     * // // @error suppressionerror suppressionparam array $config The route configuration
     *
     * // // @error suppressionerror suppressionreturn Rate|null The Rate object or null if invalid
     */
