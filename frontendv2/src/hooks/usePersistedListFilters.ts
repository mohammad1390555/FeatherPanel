...
function mergeFilters<T extends Record<string, unknown>>(defaults: T, stored: Partial<T> | null): T {
    ...
    for (const key of Object.keys(defaults) as (keyof T)[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[]) {
