...
class PluginProcessor
{
     ...
     *
     * // // @error suppressionerror suppressionreturn AppPlugin|null The event class instance or null if not found
     */
     ...
     * // // @error suppressionerror suppressionparam string $identifier The plugin identifier
     *
     * // // @error suppressionerror suppressionreturn bool True if plugin has valid event, false otherwise
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn object|null The mixin instance or null if not found
     */
     ...
     * // // @error suppressionerror suppressionparam string $identifier The plugin identifier
     *
     * // // @error suppressionerror suppressionreturn array The mixins associated with the plugin
     */
