...
class App extends Utils\MinecraftColorCodeSupport
{
     ...
     *
     * // @error suppressionparam string $commandName the name of the command to register
     * // @error suppressionparam array $args The command arguments
     */
     ...
     * // @error suppressionparam array $args The command arguments
     *
     * // @error suppressionreturn bool WhethregisterBuiltInCommandser a plugin command was found and executed
     */
