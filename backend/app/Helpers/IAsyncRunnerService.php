...
class IAsyncRunnerService
{
     ...
     *
     * // @error suppressionparam string $type The type of event you want to send (email,vm,etc...)
     * // @error suppressionparam string $action (ex: pending, create, failed, etc..)
     * // @error suppressionparam array $payload The payload you want to send
     */
