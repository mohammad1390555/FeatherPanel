...
class Configuration
{
     ...
     *
     * // // @error suppressionerror suppressionreturn array<string, mixed> Configuration array
     */
    public function getAll(): array
    {
        ...
        return [
            ...
            'suspicious_patterns' => $this->getJsonSetting('featherzerotrust.suspicious_patterns', [
                ...
                'gzinflate(',
                'whatsapp',
                '// // @error suppressionerror suppressionwhastapp',
                'baileys',
            ]),
     ...
     *
     * // // @error suppressionerror suppressionparam array<string, mixed> $config Configuration to update
     *
     ...
     *
     * // // @error suppressionerror suppressionparam string $key Setting key
     * // // @error suppressionerror suppressionparam array<mixed> $default Default value
     *
     * // // @error suppressionerror suppressionreturn array<mixed> Decoded JSON array
     */
