...
class TranslationsController
{
    ...
    public function update(Request $request, string $lang): Response
    {
        ...
        $result = // // // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionfile_put_contents($translationsPath, $jsonContent, LOCK_EX);
        if ($result === false) {
