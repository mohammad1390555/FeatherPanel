...
if (file_exists(APP_DIR . 'storage/config/.env')) {
    ...
    /**
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionglobal PluginManager $pluginManager
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionglobal PluginEvent $eventManager
     */
