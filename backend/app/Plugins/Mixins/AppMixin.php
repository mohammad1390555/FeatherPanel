...
interface AppMixin
{
     ...
     *
     * // // @error suppressionerror suppressionparam string $pluginIdentifier The identifier of the plugin using this mixin
     ...
     *
     * // // @error suppressionerror suppressionreturn string The mixin identifier
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn string The mixin version
     */
