...
class FlagCDNService
{
     ...
     *
     * // @error suppressionreturn array<string, string> Array of country codes => country names
     */
     ...
     *
     * // @error suppressionparam string $countryCode ISO 3166-1 alpha-2 country code (e.g., 'us', 'ua')
     * // @error suppressionparam int $width Width of the flag in pixels (default: 16)
     * // @error suppressionparam int $height Height of the flag in pixels (default: 12)
     *
     * // @error suppressionreturn string Flag image URL
     */
     ...
     *
     * // @error suppressionparam string $countryCode ISO 3166-1 alpha-2 country code
     *
     * // @error suppressionreturn bool True if the country code is valid
     */
     ...
     * // @error suppressionparam string $countryCode ISO 3166-1 alpha-2 country code
     *
     * // @error suppressionreturn string|null Country name or null if not found
     */
