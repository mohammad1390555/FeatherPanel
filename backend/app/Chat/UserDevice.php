...
class UserDevice
{
    ...
    /**
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string[] $deviceHashes
     *
    ...
    /**
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string[] $signalHashes
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array<int, array<string, mixed>>
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array{uuid: string, username: string, email: string}|null
     */
