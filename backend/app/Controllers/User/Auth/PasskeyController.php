...
class PasskeyController
{
    ...
    public function postAuthenticationVerify(Request $request): Response
    {
        ...
        $serializer = WebAuthnHelper::getSerializer();
        try {
            /** // // // // @error suppressionerror suppressionerror suppressionerror suppressionvar PublicKeyCredentialRequestOptions $pkOptions */
        ...
        try {
            ...
            /** // // // // @error suppressionerror suppressionerror suppressionerror suppressionvar PublicKeyCredential $pkc */
    ...
    public function postRegistrationVerify(Request $request): Response
    {
        ...
        $serializer = WebAuthnHelper::getSerializer();
        try {
            /** // // // // @error suppressionerror suppressionerror suppressionerror suppressionvar PublicKeyCredentialCreationOptions $creationOptions */
    ...
    /**
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array<string, mixed> $userInfo
     */
