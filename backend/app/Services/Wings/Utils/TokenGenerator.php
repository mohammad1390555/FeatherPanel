...
class TokenGenerator
{
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $secret The JWT secret key
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $algorithm The JWT algorithm (default: HS256)
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int $expiration Token expiration time in seconds (default: 900 = 15 minutes)
     */
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $backupUuid The backup UUID
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $uniqueId Unique request ID
     *
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $serverUuid The server UUID
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $filePath The file path
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $uniqueId Unique request ID
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows \Exception
     *
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $serverUuid The server UUID
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $userUuid The user UUID
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $permissions The permissions array (e.g., ['console', 'files', 'admin'])
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows \Exception
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn string The JWT token
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $serverUuid The server UUID
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $userUuid The user UUID
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $permissions The permissions array
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $panelUrl The panel's URL (issuer)
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $wingsUrl The Wings node's URL (audience)
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $action The specific action being performed
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows \Exception
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn string The JWT token
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $baseUrl The Wings base URL
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $serverUuid The server UUID
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $backupUuid The backup UUID
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $uniqueId Unique request ID
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows \Exception
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn string The signed URL
     */
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows \Exception
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn string The WebSocket URL
     */
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows \Exception
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array The decoded payload
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $payload The payload to encode
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows \Exception
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn string The JWT token
