...
class VdsChatbotService
{
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $message User's message
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $history Chat history (array of ['role' => 'user'|'assistant', 'content' => string])
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $user Current user data
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $pageContext Optional page context (route, vdsInstance, etc.)
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array Response with 'response', 'model', and 'tool_executions' keys
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam VdsToolHandler $toolHandler VDS tool handler instance
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn string Formatted tools information
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $provider Provider name
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $userPreferences User preferences for API keys
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam float $temperature Temperature setting
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int $maxTokens Max tokens setting
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn ProviderInterface|null Provider instance or null if invalid/unconfigured
     */
