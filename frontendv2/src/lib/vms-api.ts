...
export export interface
    success: boolean;
    data: {
        instances: VmInstance[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
