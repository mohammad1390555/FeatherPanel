...
class MountsController
{
    ...
    /**
     * // // // @error suppressionerror suppressionerror suppressionparam 'node'|'spell'|'server' $type
     */
    ...
    /**
     * // // // @error suppressionerror suppressionerror suppressionparam array<mixed> $items Per API item in the request body array
     *
