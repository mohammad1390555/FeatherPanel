...
class PluginConfig
{
     ...
     *
     * // // @error suppressionerror suppressionreturn array Optional fields with their types
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $identifier The plugin identifier
     *
     * // // @error suppressionerror suppressionreturn bool If the plugin identifier is valid
     */
     ...
     * Check if the plugin config is valid.
     *
     * // // @error suppressionerror suppressionparam array $config The plugin config
     *
     * // // @error suppressionerror suppressionreturn bool If the plugin config is valid
     */
     ...
     * // // @error suppressionerror suppressionparam string $identifier The plugin identifier
     *
     * // // @error suppressionerror suppressionreturn array The mixins configuration
     */
     ...
     * // // @error suppressionerror suppressionparam string $identifier The plugin identifier
     *
     * // // @error suppressionerror suppressionreturn array The plugin config
     */
     ...
     * // // @error suppressionerror suppressionparam string $identifier The plugin identifier
     *
     * // // @error suppressionerror suppressionreturn array The required config fields with their specifications
     */
     ...
     *
     * // // @error suppressionerror suppressionparam array $configDef The config field definition
     * // // @error suppressionerror suppressionparam mixed $value The value to validate
     *
     * // // @error suppressionerror suppressionreturn bool Whether the value is valid
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $identifier The plugin identifier
     * // // @error suppressionerror suppressionparam array $providedConfig The configuration to validate
     *
     * // // @error suppressionerror suppressionreturn array Array with validation result and errors if any
     */
     ...
     * // // @error suppressionerror suppressionparam string $identifier The plugin identifier
     *
     * // // @error suppressionerror suppressionreturn array The default configuration values
     */
     ...
     * // // @error suppressionerror suppressionparam string $identifier The plugin identifier
     *
     * // // @error suppressionerror suppressionreturn string|int|null The plugin cloud ID or null if not set
     */
     ...
     * // // @error suppressionerror suppressionparam string $identifier The plugin identifier
     *
     * // // @error suppressionerror suppressionreturn string|null The minimum panel version or null if not set
     */
     ...
     * // // @error suppressionerror suppressionparam string $identifier The plugin identifier
     *
     * // // @error suppressionerror suppressionreturn string|null The maximum panel version or null if not set
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn string The current panel version
     */
     ...
     * // // @error suppressionerror suppressionparam string $identifier The plugin identifier
     *
     * // // @error suppressionerror suppressionreturn array Array with 'compatible' boolean and 'message' string
     */
     ...
     *
     * // // @error suppressionerror suppressionparam array $config The plugin config
     * // // @error suppressionerror suppressionparam string $pluginIdentifier The plugin identifier
     *
     * // // @error suppressionerror suppressionreturn bool True if valid, false otherwise
     */
     ...
     *
     * // // @error suppressionerror suppressionparam mixed $value The value to validate
     * // // @error suppressionerror suppressionparam string $type The expected type
     *
     * // // @error suppressionerror suppressionreturn bool True if valid, false otherwise
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $version The version string
     *
     * // // @error suppressionerror suppressionreturn bool True if valid format, false otherwise
     */
     ...
     *
     * // // @error suppressionerror suppressionparam array $mixins The mixins configuration
     * // // @error suppressionerror suppressionparam string $pluginIdentifier The plugin identifier
     *
     * // // @error suppressionerror suppressionreturn bool True if valid, false otherwise
     */
