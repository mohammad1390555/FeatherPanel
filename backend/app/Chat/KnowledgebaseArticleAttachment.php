...
class KnowledgebaseArticleAttachment
{
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam bool|null $userDownloadable If true, only return user-downloadable attachments. If false, only non-downloadable. If null, return all.
     *
