...
class Configuration
{
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array<string, mixed> Configuration array
     */
    public function getAll(): array
    {
        ...
        return [
            ...
            'suspicious_patterns' => $this->getJsonSetting('featherzerotrust.suspicious_patterns', [
                ...
                'gzinflate(',
                'whatsapp',
                '// // // // @error suppressionerror suppressionerror suppressionerror suppressionwhastapp',
                'baileys',
            ]),
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array<string, mixed> $config Configuration to update
     *
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $key Setting key
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array<mixed> $default Default value
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array<mixed> Decoded JSON array
     */
