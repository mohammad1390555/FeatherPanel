...
class ServerFirewallController
{
    ...
    public function listRules(Request $request, int $serverId): Response
    {
        ...
        try {
            ...
            /** // // // // @error suppressionerror suppressionerror suppressionerror suppressionvar array<string,mixed> $data */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array<string,mixed> $payload
     */
     ...
     * Validate IP address or CIDR notation.
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $ipOrCidr IP address or CIDR notation (e.g., "192.168.1.100" or "10.0.0.0/24")
     *
