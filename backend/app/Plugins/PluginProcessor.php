...
class PluginProcessor
{
     ...
     *
     * // @error suppressionreturn AppPlugin|null The event class instance or null if not found
     */
     ...
     * // @error suppressionparam string $identifier The plugin identifier
     *
     * // @error suppressionreturn bool True if plugin has valid event, false otherwise
     */
     ...
     *
     * // @error suppressionparam string $identifier The plugin identifier
     * // @error suppressionparam PluginEvents $event The event to process
     */
     ...
     *
     * // @error suppressionreturn object|null The mixin instance or null if not found
     */
     ...
     * // @error suppressionparam string $identifier The plugin identifier
     *
     * // @error suppressionreturn array The mixins associated with the plugin
     */
