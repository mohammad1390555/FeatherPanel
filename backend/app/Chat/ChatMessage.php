...
class ChatMessage
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn int|false Message ID or false on failure
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $conversationId Conversation ID
     * // // // @error suppressionerror suppressionerror suppressionparam int $limit Maximum number of results
     *
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam int $conversationId Conversation ID
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn int Message count
     */
