...
class LogHelper
{
     ...
     *
     * // // @error suppressionerror suppressionparam string $type Log type ('web', 'app', etc.)
     *
     * // // @error suppressionerror suppressionreturn string Full path to the log file
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $type Log type ('web', 'app', 'mail', 'runner', …)
     *
     * // // @error suppressionerror suppressionreturn string Full path to the (now-guaranteed) log file
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $filePath Path to the log file
     * // // @error suppressionerror suppressionparam int $lines Number of lines to read from the end
     *
     * // // @error suppressionerror suppressionreturn string Content of the last N lines
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $content Log content to upload
     *
     * // // @error suppressionerror suppressionreturn array Upload result with 'success', 'url', 'raw', 'id' or 'error'
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $filename The log filename
     *
     * // // @error suppressionerror suppressionreturn string Log type ('web', 'app', or 'unknown')
     */
