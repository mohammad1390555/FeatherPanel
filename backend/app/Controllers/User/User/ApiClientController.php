...
class ApiClientController
{
    ...
    /**
     * // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array{ok: bool, status_code: int|null, body: string|null, error: string|null}
     */
