...
{
    /**
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionvar string The API client table name
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $data Associative array of API client fields (must include required fields)
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn int|false The new API client's ID or false on failure
     */
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $fields Fields to select (e.g. ['name', 'public_key']) (default: all)
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string|null $userUuid Filter by user UUID (optional)
     */
