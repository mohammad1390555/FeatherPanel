...
class ServersController
{
    ...
    public function update(Request $request, int $id): Response
    {
        ...
        /** // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionvar list<array{variable_id: int, variable_value: string}>|null Rows to insert after spell change (DB write deferred to transaction). */
    ...
    /**
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array<mixed> $raw
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn list<int>|Response
     */
