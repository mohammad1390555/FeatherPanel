...
{
    /**
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionvar string The server subusers table name
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $data Associative array of subuser fields
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn int|false The new subuser's ID or false on failure
     */
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $search Search term for user or server (optional)
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $fields Fields to select (e.g. ['user_id', 'server_id']) (default: all)
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string|null $permission Filter by permission (optional)
     */
