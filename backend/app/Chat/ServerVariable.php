...
{
    /**
     * // // // @error suppressionerror suppressionerror suppressionvar string The server_variables table name
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array $data Associative array of server variable fields
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn int|false The new server variable's ID or false on failure
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $id The server variable ID
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array|null The server variable data or null if not found
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of server variables
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam int $serverId The server ID
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of server variables with spell variable details
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $id The server variable ID
     * // // // @error suppressionerror suppressionerror suppressionparam array $data The data to update
     *
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $serverId The server ID
     * // // // @error suppressionerror suppressionerror suppressionparam array $variables Array of variables with variable_id and variable_value
     * // // // @error suppressionerror suppressionerror suppressionparam \PDO|null $externalPdo When provided and already in a transaction, run without nested begin/commit
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn bool True on success, false on failure
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam int $serverId The server ID
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn int The count
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of all server variables
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array $data The data to sanitize
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array The sanitized data
     */
