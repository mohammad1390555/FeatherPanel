...
class Proxmox
{
    ...
    /** // // @error suppressionerror suppressionvar array<string, string> */
    private array $defaultExtraHeaders;
    /** // // @error suppressionerror suppressionvar array<string, string|int|float> */
    private array $defaultExtraQuery;

    /**
     * // // @error suppressionerror suppressionparam string $host Proxmox hostname or IP
     * // // @error suppressionerror suppressionparam int $port Proxmox API port (default 8006, or 443 if proxied)
     * // // @error suppressionerror suppressionparam string $scheme http or https
     * // // @error suppressionerror suppressionparam string $user Proxmox user, e.g. root// // @error suppressionerror suppressionpam or apiuser// // @error suppressionerror suppressionpve
     * // // @error suppressionerror suppressionparam string $tokenId Token ID (part after user, before = in PVEAPIToken)
     * // // @error suppressionerror suppressionparam string $secret Token secret
     * // // @error suppressionerror suppressionparam bool $tlsNoVerify Whether to skip TLS verification
     * // // @error suppressionerror suppressionparam int $timeout Timeout in seconds
     * // // @error suppressionerror suppressionparam array<string, string> $defaultExtraHeaders Default extra headers to send with every request (e.g. X-Forwarded-For)
     * // // @error suppressionerror suppressionparam array<string, string|int|float> $defaultExtraQuery Default extra query parameters to send with every request
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, data: array<string, mixed>|null, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, nodes: array<int, mixed>, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $node Proxmox node name (e.g. pve)
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, bridges: array<int, string>, error: string|null}
     */
     ...
     * // // @error suppressionerror suppressionparam string $node Proxmox node name (e.g. pve)
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, storage: array<int, string>, error: string|null}
     */
     ...
     * - content=iso
     * - filename=// // @error suppressionerror suppression<file>
     *
     * // // @error suppressionerror suppressionparam string $node Proxmox node name
     * // // @error suppressionerror suppressionparam string $storage Proxmox storage name
     * // // @error suppressionerror suppressionparam string $filePath local filesystem path to the ISO file
     * // // @error suppressionerror suppressionparam string $filename ISO filename (as it should appear in Proxmox)
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, volid: string|null, error: string|null}
     */
    public function uploadIsoToStorage(string $node, string $storage, string $filePath, string $filename): array
    {
        ...
        try {
            $mime = function_exists('mime_content_type') ? (string) // // @error suppressionerror suppressionmime_content_type($filePath) : '';
     ...
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, size: int|null, filename: string|null, mimetype: string|null, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, upid: string|null, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionparam array<string, string> $extraHeaders additional headers to send for this check
     * // // @error suppressionerror suppressionparam array<string, string|int|float> $extraQuery additional query parameters to send
     *
     ...
     *
     * // // @error suppressionerror suppressionparam string $path e.g. /api2/json/cluster/nextid
     * // // @error suppressionerror suppressionparam array<string, string|int> $query
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, data: mixed, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $path e.g. /api2/json/nodes/pve/qemu/100/clone
     * // // @error suppressionerror suppressionparam array<string, mixed> $body
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, data: mixed, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $path e.g. /api2/json/nodes/pve/lxc/100/config
     * // // @error suppressionerror suppressionparam array<string, mixed> $body Form params (delete, net0, memory, etc.)
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, data: mixed, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $path e.g. /api2/json/nodes/pve/qemu/100
     * // // @error suppressionerror suppressionparam array<string, string|int> $query
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, data: mixed, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, vmid: int|null, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $node Proxmox node name (e.g. pve)
     * // // @error suppressionerror suppressionparam int $templateVmid Template VMID
     * // // @error suppressionerror suppressionparam int $newid New VM ID
     * // // @error suppressionerror suppressionparam string $name New VM name
     * // // @error suppressionerror suppressionparam string|null $target Target node (default same as node)
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, upid: string|null, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $node Proxmox node name where the template lives
     * // // @error suppressionerror suppressionparam int $templateVmid Template container VMID
     * // // @error suppressionerror suppressionparam int $newid New container VMID
     * // // @error suppressionerror suppressionparam string $hostname New container hostname
     * // // @error suppressionerror suppressionparam string|null $target Target node (default same as node)
     * // // @error suppressionerror suppressionparam string|null $storage Target storage for full clone (e.g. local); required for full clone
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, upid: string|null, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, status: string|null, exitstatus: string|null, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionparam int $maxWaitSec Max seconds to wait
     * // // @error suppressionerror suppressionparam int $intervalSec Seconds between polls
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, config: array<string, mixed>|null, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $node Proxmox node name
     * // // @error suppressionerror suppressionparam int $vmid VMID
     * // // @error suppressionerror suppressionparam 'qemu'|'lxc' $vmType
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, status: array<string, mixed>|null, error: string|null}
     */
     ...
     * // // @error suppressionerror suppressionparam 'qemu'|'lxc' $vmType
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, ticket: string|null, port: int|null, cert: string|null, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, ticket: string|null, csrf: string|null, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, users: array<int, array<string, mixed>>, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionparam int|null $expire Unix timestamp when the user expires (optional)
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionparam array<string, mixed> $config Keys as Proxmox expects (memory, sockets, cores, ipconfig0, net0, etc.)
     * // // @error suppressionerror suppressionparam array<int, string> $deleteKeys Optional keys to remove from config (e.g. ['net0'] to purge template IP)
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionparam array<int, string> $ids e.g. ['scsi1'] or ['unused0']
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, node: string|null, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, storages: array<int, string>, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, backups: array<int, mixed>, storages: array<int, string>, error: string|null}
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array{ok: bool, vms: array<int, array{vmid: int, name: string, node: string, template: int, type: string}>, error: string|null}
     */
