...
{
    /**
     * // @error suppressionvar array Supported time units and their minute equivalents
     */
    ...
    /**
     * // @error suppressionvar string The unique identifier for this cron job
     */
    private string $identifier;

    /**
     * // @error suppressionvar int Minutes between executions
     */
    private int $interval;

    /**
     * // @error suppressionvar string Path to store last run timestamps
     */
     ...
     *
     * // @error suppressionparam string $identifier Unique identifier for this cron job
     * // @error suppressionparam string $interval Interval string (e.g., "30M", "1H", "1D")
     *
     * // @error suppressionthrows \Exception If interval format is invalid
     */
     ...
     *
     * // @error suppressionparam callable $callback Function to execute
     *
     * // @error suppressionreturn bool Whether the job was executed
     */
     ...
     * // @error suppressionthrows \Exception If interval format is invalid
     *
     * // @error suppressionreturn int Minutes
     */
