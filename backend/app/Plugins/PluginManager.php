...
class PluginManager
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array The loaded memory plugins
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array List of plugin names without loading
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $plugin The plugin identifier
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array List of mixin instances
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $plugin The plugin identifier
     * // // // @error suppressionerror suppressionerror suppressionparam array $config The plugin configuration
     */
