...
class DnsResolver
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $hostname The hostname to resolve
     * // // // @error suppressionerror suppressionerror suppressionparam bool $useIpv6 Whether to prefer IPv6 addresses
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string|null The resolved IP address or null if resolution fails
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam string $hostname The hostname to resolve
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of IP addresses
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $hostname The hostname to test
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Detailed resolution results
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Cache statistics
     */
     ...
     * Set cache timeout.
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $timeout Cache timeout in seconds
     */
