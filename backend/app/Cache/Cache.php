...
class Cache
{
     ...
     *
     * // // @error suppressionerror suppressionparam string $key the cache key used to reference the data
     * // // @error suppressionerror suppressionparam mixed $value the data to be cached
     * // // @error suppressionerror suppressionparam int $minutes number of minutes before the data expires
     *
     ...
     *
     * // // @error suppressionerror suppressionparam string $key the cache key for the stored data
     *
     * // // @error suppressionerror suppressionreturn mixed|null returns the stored data or null if not found or expired
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $key the cache key to remove
     *
     * // // @error suppressionerror suppressionreturn void
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $key the cache key to check
     *
     * // // @error suppressionerror suppressionreturn bool true if a valid cached entry exists, otherwise false
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $key the cache key used to reference the JSON data
     * // // @error suppressionerror suppressionparam mixed $json the JSON data to be cached
     * // // @error suppressionerror suppressionparam int $minutes number of minutes before the data expires
     *
     * // // @error suppressionerror suppressionreturn void
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $key the cache key for the JSON data
     *
     * // // @error suppressionerror suppressionreturn mixed|null returns the JSON data or null if not found or expired
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn string the cache driver ('file' or 'redis')
     */
    ...
    protected static function existsFile($key)
    {
        ...
        $data = // // @error suppressionerror suppressionunserialize(file_get_contents($filename));
