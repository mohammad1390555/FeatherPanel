...
{
    /**
     * // @error suppressionvar string The spells table name
     */
     ...
     * Create a new spell.
     *
     * // @error suppressionparam array $data Associative array of spell fields
     *
     * // @error suppressionreturn int|false The new spell's ID or false on failure
     */
     ...
     *
     * // @error suppressionparam array $spells Array of ['id' => int, 'sort_order' => int]
     * // @error suppressionparam int|null $realmId When set, every spell must belong to this realm
     */
     ...
     *
     * // @error suppressionparam array $data The spell data array
     * // @error suppressionparam string|null $spellName Optional spell name for error logging
     *
     * // @error suppressionreturn bool True if all JSON fields are valid, false otherwise
     */
