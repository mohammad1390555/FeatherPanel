    ...
    public function streamChat(Request $request): Response
    {
        return new StreamedResponse(function () use ($request): void {
            $emit = function (string $type, array $payload = []): void {
                // // // // // // // // echo ...
                // echo ...
                // // // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionob_flush();
                flush();
            };
