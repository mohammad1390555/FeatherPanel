...
{
    /**
     * // // @error suppressionerror suppressionparam array<string, mixed> $options
     ...
     *
     * // // @error suppressionerror suppressionreturn array{success: bool, error?: string, code?: string, http_status?: int, transfer_id?: int|false, new_allocation?: int|null, new_additional_allocations?: int[]}
     */
    ...
    /**
     * // // @error suppressionerror suppressionparam array<int> $serverIds Empty means all transferable servers on the source node
     *
     ...
     *
     * // // @error suppressionerror suppressionreturn array{success: bool, picked: array<int>, error?: string, code?: string, http_status?: int}
     */
