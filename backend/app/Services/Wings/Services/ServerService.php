...
class ServerService
{
     ...
     * Get server logs.
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int $lines Number of lines to get (default: 100)
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam bool $includeDirectorySizes when true, requests Wings recursive per-folder sizes (cached on the daemon)
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array<string,mixed> $filters
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $innerPath Path inside the archive (empty string = root)
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array<string, mixed> $options Optional keys: use_trash (bool), permanent (bool), trash (array{max_size_bytes?: int, retention_days?: int})
     */
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $root The root directory path
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $files Array of file names (relative to root)
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $name Optional archive name (empty for auto-generated)
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $extension Archive extension (zip, tar.gz, tgz, tar.bz2, tbz2, tar.xz, txz)
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int|null $timeout Optional timeout in seconds (default: 15 minutes for large archives)
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $serverUuid The server UUID
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $file The archive file path
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $root The root directory path
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int|null $timeout Optional timeout in seconds (default: 15 minutes for large archives)
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array<int, string> $entries Paths inside the archive (files and/or directories)
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressiondeprecated Use deAuthUser instead
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $user The user to deauthorize
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $serverUuid The server UUID
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array<string,mixed> $data Import configuration data
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array<string,mixed> $data FastDL configuration data (optional directory)
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array<string,mixed> $data FastDL configuration data
     */
