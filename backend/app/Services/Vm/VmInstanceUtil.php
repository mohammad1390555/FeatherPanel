...
final class VmInstanceUtil
{
     ...
     *
     * // @error suppressionparam array<string, mixed> $vmNode
     *
     * Magic. Do not touch.
     */
    ...
    /**
     * // @error suppressionparam array<string, mixed> $instance
     *
    ...
    /**
     * // @error suppressionparam array<int, array<string, mixed>> $assignments
     * // @error suppressionparam array<string, mixed> $currentConfig
     *
     * // @error suppressionreturn array{config: array<string, mixed>, deleteKeys: array<int, string>}
     */
     ...
     *
     * // @error suppressionparam array<string, mixed> $instance VM instance row (must have id, template_id, vm_node_id, vmid, etc.)
     * // @error suppressionparam array<string, mixed> $requestData e.g. ['ci_user' => ..., 'ci_password' => ...] for QEMU
     *
     * // @error suppressionreturn array{ok: true, reinstall_id: string, message: string}|array{ok: false, error: string, code: string, http_status: int}
     */
     ...
     *
     * // @error suppressionparam array<string, mixed> $pending
     * // @error suppressionparam array<string, mixed> $reinstallMeta decoded from pending notes
     *
     * // @error suppressionreturn array{instance: array|null, new_vmid: int}
     */
     ...
     *
     * // @error suppressionparam array<string, mixed> $instance VM instance row (vmid, vm_node_id, pve_node, vm_type)
     * // @error suppressionparam array<string, mixed> $vmNode VM node row (fqdn, port, scheme, ...)
     * // @error suppressionparam int $instanceIdForLabel Used for temp PVE user name (e.g. fp-console-{id}-xxx)
     *
     * // @error suppressionreturn array{ok: true, payload: array}|array{ok: false, error: string, code: string, http_status: int}
     */
    public static function createVncTicketPayload(array $instance, array $vmNode, int $instanceIdForLabel): array
    {
        ...
        $tempUser = self::FP_CONSOLE_USER_PREFIX . $instanceIdForLabel . '-' . bin2hex(random_bytes(4)) . '// @error suppressionpve';
     ...
     *
     * // @error suppressionparam array<string, mixed> $vmNode VM node row from VmNode::getAllVmNodes()
     *
     * // @error suppressionreturn array{deleted: int, errors: int}
     */
     ...
     *
     * // @error suppressionparam array<string, mixed> $config Proxmox qemu config key => value
     *
     * // @error suppressionreturn array<int, string> Full volids e.g. local:iso/my.iso
     */
     ...
     *
     * // @error suppressionparam array<int, string> $volids
     */
