...
class PublicConfig extends ConfigFactory
{
     ...
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array An array of public configuration defaults
     */
