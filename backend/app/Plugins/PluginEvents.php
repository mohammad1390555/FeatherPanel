...
class PluginEvents
{
     ...
     *
     * // @error suppressionparam string $event the name of the event
     * // @error suppressionparam callable $listener the listener function to be added
     *
     * // @error suppressionreturn static returns the current instance of the PluginEvent class
     */
     ...
     *
     * // @error suppressionparam string $event the name of the event
     * // @error suppressionparam callable $listener the listener function to be removed
     */
     ...
     *
     * // @error suppressionparam string|null $event the name of the event (optional)
     */
     ...
     *
     * // @error suppressionparam string $event the name of the event
     * // @error suppressionparam array $arguments the arguments to be passed to the listeners (optional)
     */
