...
trait CheckSubuserPermissionsTrait
{
     ...
     *
     * // @error suppressionparam Request $request The request object
     * // @error suppressionparam array $server The server array
     * // @error suppressionparam string $permission The permission to check
     *
     * // @error suppressionreturn Response|null Response if permission denied, null if allowed
     */
