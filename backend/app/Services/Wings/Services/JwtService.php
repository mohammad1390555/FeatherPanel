...
class JwtService
{
     ...
     *
     * // // @error suppressionerror suppressionparam string $nodeSecret The Wings node's secret key
     ...
     * // // @error suppressionerror suppressionparam int $expiration Token expiration time in seconds (default: 600 = 10 minutes)
     */
     ...
     * // // @error suppressionerror suppressionparam array $permissions The user's permissions
     * // // @error suppressionerror suppressionparam string $action The specific action (start, stop, restart, etc.)
     *
     ...
     * // // @error suppressionerror suppressionparam string $userUuid The user UUID
     * // // @error suppressionerror suppressionparam array $permissions The user's permissions
     * // // @error suppressionerror suppressionparam string $operation The file operation (read, write, delete, upload, download)
     * // // @error suppressionerror suppressionparam string $filePath The file path (if applicable)
     *
     * // // @error suppressionerror suppressionthrows \Exception
     *
     * // // @error suppressionerror suppressionreturn string The JWT token
     ...
     * // // @error suppressionerror suppressionparam string $userUuid The user UUID
     * // // @error suppressionerror suppressionparam array $permissions The user's permissions
     * // // @error suppressionerror suppressionparam string $operation The Docker operation (rebuild, logs, etc.)
     *
     * // // @error suppressionerror suppressionthrows \Exception
     *
     * // // @error suppressionerror suppressionreturn string The JWT token
     ...
     * // // @error suppressionerror suppressionparam string $userUuid The user UUID
     * // // @error suppressionerror suppressionparam array $permissions The user's permissions
     * // // @error suppressionerror suppressionparam string $operation The system operation (logs, resources, etc.)
     *
     * // // @error suppressionerror suppressionthrows \Exception
     *
     * // // @error suppressionerror suppressionreturn string The JWT token
     ...
     *
     * // // @error suppressionerror suppressionparam string $token The JWT token to validate
     *
     * // // @error suppressionerror suppressionthrows \Exception
     *
     * // // @error suppressionerror suppressionreturn array The decoded token payload
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $token The JWT token to check
     *
     ...
     *
     * // // @error suppressionerror suppressionparam string $serverUuid The destination server UUID (used as subject)
     * // // @error suppressionerror suppressionparam string $userUuid The user UUID initiating the transfer
     * // // @error suppressionerror suppressionparam array $permissions The user's permissions
     *
     * // // @error suppressionerror suppressionthrows \Exception
     *
