...
class SubuserPermissionChecker
{
     ...
     * // @error suppressionparam string $permission The permission to check (e.g., 'file.read', 'backup.create')
     *
     * // @error suppressionreturn bool True if the user has the permission, false otherwise
     */
     ...
     * // @error suppressionparam int $userId The user ID
     * // @error suppressionparam int $serverId The server ID
     * // @error suppressionparam array $permissions Array of permissions to check
     *
     * // @error suppressionreturn bool True if the user has at least one of the permissions
     */
     ...
     * // @error suppressionparam array $permissions Array of permissions to check
     *
     * // @error suppressionreturn bool True if the user has all of the permissions
     */
     ...
     *
     * // @error suppressionparam string $controller The controller name (e.g., 'files', 'backups', 'databases')
     * // @error suppressionparam string $action The action name (e.g., 'list', 'create', 'update', 'delete')
     *
     * // @error suppressionreturn string|null The required permission, or null if not mapped
     */
