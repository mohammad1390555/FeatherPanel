...
class PluginSettings extends PluginDB
{
     ...
     *
     * // @error suppressionparam string $identifier The identifier of the plugin
     * // @error suppressionparam string $key The key of the setting
     * // @error suppressionparam array $settings The settings to set
     *
     * // @error suppressionthrows \PDOException If database operation fails
     * // @error suppressionthrows \InvalidArgumentException If input validation fails
     */
     ...
     * // @error suppressionthrows \InvalidArgumentException If input validation fails
     *
     * // @error suppressionreturn string The value of the setting
     */
     ...
     * // @error suppressionthrows \InvalidArgumentException If input validation fails
     *
     * // @error suppressionreturn array All settings for the plugin
     */
     ...
     *
     * // @error suppressionparam string $identifier The identifier to validate
     * // @error suppressionparam string|null $key The key to validate (optional)
     *
     * // @error suppressionthrows \InvalidArgumentException If validation fails
     */
     ...
     *
     * // @error suppressionparam string $input The input to sanitize
     *
     * // @error suppressionreturn string The sanitized input
     */
