...
class FlagCDNService
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array<string, string> Array of country codes => country names
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $countryCode ISO 3166-1 alpha-2 country code (e.g., 'us', 'ua')
     * // // // @error suppressionerror suppressionerror suppressionparam int $width Width of the flag in pixels (default: 16)
     * // // // @error suppressionerror suppressionerror suppressionparam int $height Height of the flag in pixels (default: 12)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string Flag image URL
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $countryCode ISO 3166-1 alpha-2 country code
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn bool True if the country code is valid
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam string $countryCode ISO 3166-1 alpha-2 country code
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string|null Country name or null if not found
     */
