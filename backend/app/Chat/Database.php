...
class Database
{
     ...
     *
     * // @error suppressionparam string $host the hostname or path to the database
     * // @error suppressionparam string $dbName the name of the database (not used for sqlite)
     * // @error suppressionparam string|null $username the username for the database connection (not used for sqlite)
     * // @error suppressionparam string|null $password the password for the database connection (not used for sqlite)
     * // @error suppressionparam int $port the port to use for the database connection
     *
     * // @error suppressionthrows \Exception if an unsupported database type is provided or the connection fails
     */
     ...
     *
     * // @error suppressionreturn \PDO the PDO connection
     */
     ...
     *
     * // @error suppressionparam string $table the table name
     */
     ...
     *
     * // @error suppressionparam string $table the table name
     * // @error suppressionparam array $where the where conditions
     * // @error suppressionparam bool $includeDeleted whether to include deleted records
     *
     * // @error suppressionreturn int the number of rows in the table
     */
     ...
     * // @error suppressionparam string $table the table name
     *
     * // @error suppressionreturn bool true if the table exists, false otherwise
     */
     ...
     *
     * // @error suppressionparam string $table the name of the table containing the record
     * // @error suppressionparam int $row the ID of the record to mark as deleted
     */
     ...
     *
     * // @error suppressionparam string $table the name of the table to query
     *
     * // @error suppressionreturn array array of deleted records in associative array format
     */
     ...
     *
     * // @error suppressionparam string $table the name of the table containing the record
     * // @error suppressionparam int $row the ID of the record to restore
     */
     ...
     *
     * // @error suppressionparam string $table the name of the table containing the record
     * // @error suppressionparam int $row the ID of the record to delete
     */
     ...
     *
     * // @error suppressionparam string $table the name of the table containing the record
     * // @error suppressionparam int $row the ID of the record to lock
     */
     ...
     *
     * // @error suppressionparam string $table the name of the table containing the record
     * // @error suppressionparam int $row the ID of the record to unlock
     */
     ...
     *
     * // @error suppressionparam string $table the name of the table containing the record
     * // @error suppressionparam int $row the ID of the record to check
     *
     * // @error suppressionreturn bool returns true if the record is locked, false otherwise
     */
     ...
     * Run a SQL query.
     *
     * // @error suppressionparam string $sql the SQL query to run
     *
     * // @error suppressionreturn array the result of the SQL query
     */
     ...
     * // @error suppressionparam string $table the table name
     *
     * // @error suppressionreturn int the last insert ID
     */
     ...
     *
     * // @error suppressionparam string $table the table name
     * // @error suppressionparam int $row the ID of the record to save and unlock
     */
     ...
     * Run a raw SQL query.
     *
     * // @error suppressionparam string $query the SQL query to run
     *
     * // @error suppressionreturn array the result of the SQL query
     */
