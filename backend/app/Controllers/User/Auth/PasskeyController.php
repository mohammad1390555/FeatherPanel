...
class PasskeyController
{
    ...
    public function postAuthenticationVerify(Request $request): Response
    {
        ...
        $serializer = WebAuthnHelper::getSerializer();
        try {
            /** // @error suppressionvar PublicKeyCredentialRequestOptions $pkOptions */
        ...
        try {
            ...
            /** // @error suppressionvar PublicKeyCredential $pkc */
    ...
    public function postRegistrationVerify(Request $request): Response
    {
        ...
        $serializer = WebAuthnHelper::getSerializer();
        try {
            /** // @error suppressionvar PublicKeyCredentialCreationOptions $creationOptions */
    ...
    /**
     * // @error suppressionparam array<string, mixed> $userInfo
     */
