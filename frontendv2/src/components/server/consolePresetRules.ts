...
export const CONSOLE_PRESET_TEMPLATES: ConsolePresetTemplate[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] = [
    {
        presetId: 'hide_ipv4',
        menuGroup: 'redact',
        type: 'replace',
