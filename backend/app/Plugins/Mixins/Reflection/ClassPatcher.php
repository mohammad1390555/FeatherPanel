...
class ClassPatcher
{
    /** // // @error suppressionerror suppressionvar array Cached reflection classes */
    private static array $reflectionCache = [];

    /** // // @error suppressionerror suppressionvar array Method patches by class and method name */
    private static array $methodPatches = [];

    /** // // @error suppressionerror suppressionvar array Class proxies by class name */
    private static array $classProxies = [];

    /** // // @error suppressionerror suppressionvar array Property overrides by class and property name */
    private static array $propertyOverrides = [];

    /**
     * Get a ReflectionClass instance for a class.
     *
     * // // @error suppressionerror suppressionparam string|object $class Class name or object instance
     *
     * // // @error suppressionerror suppressionreturn \ReflectionClass The reflection class
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $className The class name
     * // // @error suppressionerror suppressionparam string $methodName The method name
     * // // @error suppressionerror suppressionparam \Closure $patchCallback The patch callback
     * // // @error suppressionerror suppressionparam string $patchType The patch type: 'before', 'after', 'around', or 'replace'
     *
     * // // @error suppressionerror suppressionreturn bool True if successfully patched
     */
     ...
     * // // @error suppressionerror suppressionparam string $className The class name
     * // // @error suppressionerror suppressionparam string $methodName The method name
     * // // @error suppressionerror suppressionparam \Closure $callback The callback to execute before the method
     *
     * // // @error suppressionerror suppressionreturn bool True if successfully patched
     */
     ...
     * // // @error suppressionerror suppressionparam string $className The class name
     * // // @error suppressionerror suppressionparam string $methodName The method name
     * // // @error suppressionerror suppressionparam \Closure $callback The callback to execute after the method
     *
     * // // @error suppressionerror suppressionreturn bool True if successfully patched
     */
     ...
     * // // @error suppressionerror suppressionparam string $className The class name
     * // // @error suppressionerror suppressionparam string $methodName The method name
     * // // @error suppressionerror suppressionparam \Closure $callback The replacement method
     *
     * // // @error suppressionerror suppressionreturn bool True if successfully patched
     */
     ...
     * // // @error suppressionerror suppressionparam string $className The class name
     * // // @error suppressionerror suppressionparam string $methodName The method name
     * // // @error suppressionerror suppressionparam \Closure $callback The callback to execute around the method
     *
     * // // @error suppressionerror suppressionreturn bool True if successfully patched
     */
     ...
     *
     * // // @error suppressionerror suppressionparam object $instance The object instance
     * // // @error suppressionerror suppressionparam string $methodName The method name
     ...
     *
     * // // @error suppressionerror suppressionparam string $className The class name
     * // // @error suppressionerror suppressionparam string $propertyName The property name
     * // // @error suppressionerror suppressionparam mixed $value The new value
     *
     * // // @error suppressionerror suppressionreturn bool True if successfully overridden
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $className The class name
     * // // @error suppressionerror suppressionparam array $methodOverrides Method overrides
     * // // @error suppressionerror suppressionparam array $propertyOverrides Property overrides
     *
     * // // @error suppressionerror suppressionreturn string The proxy class name
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $className The class name
     * // // @error suppressionerror suppressionparam array $constructorArgs Constructor arguments
     *
     * // // @error suppressionerror suppressionreturn object The proxy instance
     */
     ...
     *
     * // // @error suppressionerror suppressionparam \ReflectionClass $reflection The reflection class
     * // // @error suppressionerror suppressionparam string $proxyClassName The proxy class name
     * // // @error suppressionerror suppressionparam array $methodOverrides Method overrides
     * // // @error suppressionerror suppressionparam array $propertyOverrides Property overrides
     *
     * // // @error suppressionerror suppressionreturn string The proxy class code
     */
