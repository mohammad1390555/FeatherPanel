...
class Cache
{
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $key the cache key used to reference the data
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam mixed $value the data to be cached
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $minutes number of minutes before the data expires
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn void
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $key the cache key for the stored data
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn mixed|null returns the stored data or null if not found or expired
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $key the cache key to remove
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn void
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $key the cache key to check
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool true if a valid cached entry exists, otherwise false
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $key the cache key used to reference the JSON data
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam mixed $json the JSON data to be cached
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $minutes number of minutes before the data expires
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn void
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $key the cache key for the JSON data
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn mixed|null returns the JSON data or null if not found or expired
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn string the cache driver ('file' or 'redis')
     */
    ...
    protected static function existsFile($key)
    {
        ...
        $data = // // // // @error suppressionerror suppressionerror suppressionerror suppressionunserialize(file_get_contents($filename));
