...
class Mount
{
    ...
    /** // @error suppressionvar string[] Disallowed host source paths */
    ...
    /** // @error suppressionvar string[] Disallowed container targets (default data mount is reserved). */
    ...
    /**
     * // @error suppressionreturn array{error: ?string, source: string, target: string}
     */
    ...
    /**
     * // @error suppressionparam array{name:string,description?:?string,source:string,target:string,read_only?:bool,user_mountable?:bool} $data omit user_mountable for default true (Pelican admin create always enables this)
     */
    ...
    /**
     * // @error suppressionparam array{name?:string,description?:?string,source?:string,target?:string,read_only?:bool|int,user_mountable?:bool|int} $data
     */
     ...
     *
     * // @error suppressionparam int[] $entityIds node IDs, spell IDs, or server IDs depending on $type
     */
    ...
    /**
     * // @error suppressionreturn list<array{source:string,target:string,read_only:bool}>
     */
     ...
     *
     * // @error suppressionparam ?int $spellIdOverride When set (e.g. draft spell in admin UI), filter by this spell instead of the server's stored spell_id.
     *
     * // @error suppressionreturn array<int, array<string, mixed>>
     */
    ...
    /**
     * // @error suppressionparam int[] $mountIds
     */
     ...
     *
     * // @error suppressionparam int[] $nodeIds
     * // @error suppressionparam int[] $spellIds integer IDs (>0) after validation
     */
