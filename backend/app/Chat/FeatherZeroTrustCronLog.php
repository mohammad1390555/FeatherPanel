...
class FeatherZeroTrustCronLog
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array $data Execution data
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string|false Execution ID or false on failure
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $executionId Execution ID
     * // // // @error suppressionerror suppressionerror suppressionparam array $data Update data
     *
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $limit Limit
     * // // // @error suppressionerror suppressionerror suppressionparam int $offset Offset
     * // // // @error suppressionerror suppressionerror suppressionparam string $status Filter by status
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Cron logs
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn int Count
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam string $executionId Execution ID
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array|null Cron log or null
     */
