...
class Database
{
     ...
     *
     * // // @error suppressionerror suppressionparam string $host the hostname or path to the database
     * // // @error suppressionerror suppressionparam string $dbName the name of the database (not used for sqlite)
     * // // @error suppressionerror suppressionparam string|null $username the username for the database connection (not used for sqlite)
     * // // @error suppressionerror suppressionparam string|null $password the password for the database connection (not used for sqlite)
     * // // @error suppressionerror suppressionparam int $port the port to use for the database connection
     *
     * // // @error suppressionerror suppressionthrows \Exception if an unsupported database type is provided or the connection fails
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn \PDO the PDO connection
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $table the table name
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $table the table name
     * // // @error suppressionerror suppressionparam array $where the where conditions
     * // // @error suppressionerror suppressionparam bool $includeDeleted whether to include deleted records
     *
     * // // @error suppressionerror suppressionreturn int the number of rows in the table
     */
     ...
     * // // @error suppressionerror suppressionparam string $table the table name
     *
     * // // @error suppressionerror suppressionreturn bool true if the table exists, false otherwise
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $table the name of the table containing the record
     * // // @error suppressionerror suppressionparam int $row the ID of the record to mark as deleted
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $table the name of the table to query
     *
     * // // @error suppressionerror suppressionreturn array array of deleted records in associative array format
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $table the name of the table containing the record
     * // // @error suppressionerror suppressionparam int $row the ID of the record to restore
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $table the name of the table containing the record
     * // // @error suppressionerror suppressionparam int $row the ID of the record to delete
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $table the name of the table containing the record
     * // // @error suppressionerror suppressionparam int $row the ID of the record to lock
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $table the name of the table containing the record
     * // // @error suppressionerror suppressionparam int $row the ID of the record to unlock
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $table the name of the table containing the record
     * // // @error suppressionerror suppressionparam int $row the ID of the record to check
     *
     * // // @error suppressionerror suppressionreturn bool returns true if the record is locked, false otherwise
     */
     ...
     * Run a SQL query.
     *
     * // // @error suppressionerror suppressionparam string $sql the SQL query to run
     *
     * // // @error suppressionerror suppressionreturn array the result of the SQL query
     */
     ...
     * // // @error suppressionerror suppressionparam string $table the table name
     *
     * // // @error suppressionerror suppressionreturn int the last insert ID
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $table the table name
     * // // @error suppressionerror suppressionparam int $row the ID of the record to save and unlock
     */
     ...
     * Run a raw SQL query.
     *
     * // // @error suppressionerror suppressionparam string $query the SQL query to run
     *
     * // // @error suppressionerror suppressionreturn array the result of the SQL query
     */
