...
class PterodactylImporterController
{
    ...
    public function importUser(Request $request): Response
    {
        try {
            ...
            // Validate email format (lenient - just check for // // // // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppression and basic structure)
