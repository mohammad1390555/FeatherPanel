...
class App
{
    ...
    public function __construct(bool $softBoot, bool $isCron = false, bool $isCli = false)
    {
        ...
        /**
         * // // // @error suppressionerror suppressionerror suppressionglobal \App\Plugins\PluginManager $pluginManager
         * // // // @error suppressionerror suppressionerror suppressionglobal \App\Plugins\Events\PluginEvent $eventManager
         * // // // @error suppressionerror suppressionerror suppressionglobal \Redis $redis
         */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam RouteCollection $routes The Symfony RouteCollection instance
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam RouteCollection $routes The Symfony RouteCollection instance to add the route to
     * // // // @error suppressionerror suppressionerror suppressionparam string $name The name of the route
     * // // // @error suppressionerror suppressionerror suppressionparam string $path The URL path for the route (e.g. '/api/admin/dashboard')
     * // // // @error suppressionerror suppressionerror suppressionparam callable $controller The controller to handle the request
     * // // // @error suppressionerror suppressionerror suppressionparam Permissions|string $permission The permission node required to access this route
     * // // // @error suppressionerror suppressionerror suppressionparam array $methods The HTTP methods allowed for this route (default: ['GET'])
     * // // // @error suppressionerror suppressionerror suppressionparam Rate|null $rateLimit Optional default rate limit for this route (e.g., Rate::perMinute(60))
     *                             Admin can override this in ratelimit.json
     * // // // @error suppressionerror suppressionerror suppressionparam string|null $rateLimitNamespace Optional default namespace for rate limiting (default: 'rate_limit')
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam RouteCollection $routes The Symfony RouteCollection instance to add the route to
     * // // // @error suppressionerror suppressionerror suppressionparam string $name The name of the route
     * // // // @error suppressionerror suppressionerror suppressionparam string $path The URL path for the route (e.g. '/api/user/profile')
     * // // // @error suppressionerror suppressionerror suppressionparam callable $controller The controller to handle the request
     * // // // @error suppressionerror suppressionerror suppressionparam array $methods the HTTP methods allowed for this route (default: ['GET'])
     * // // // @error suppressionerror suppressionerror suppressionparam Rate|null $rateLimit Optional default rate limit for this route (e.g., Rate::perMinute(60))
     *                             Admin can override this in ratelimit.json
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam RouteCollection $routes The Symfony RouteCollection instance to add the route to
     * // // // @error suppressionerror suppressionerror suppressionparam string $name The name of the route
     * // // // @error suppressionerror suppressionerror suppressionparam string $path The URL path for the route (e.g. '/api/server/data')
     * // // // @error suppressionerror suppressionerror suppressionparam callable $controller The controller to handle the request
     * // // // @error suppressionerror suppressionerror suppressionparam string $serverShortUuid The server short UUID
     * // // // @error suppressionerror suppressionerror suppressionparam array $methods The HTTP methods allowed for this route (default: ['GET'])
     * // // // @error suppressionerror suppressionerror suppressionparam Rate|null $rateLimit Optional default rate limit for this route (e.g., Rate::perMinute(60))
     *                             Admin can override this in ratelimit.json
     * // // // @error suppressionerror suppressionerror suppressionparam string|null $rateLimitNamespace Optional default namespace for rate limiting (default: 'rate_limit')
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam RouteCollection $routes The Symfony RouteCollection instance to add the route to
     * // // // @error suppressionerror suppressionerror suppressionparam string $name The name of the route
     * // // // @error suppressionerror suppressionerror suppressionparam string $path The URL path for the route (e.g. '/api/user/vm-instances/{id}')
     * // // // @error suppressionerror suppressionerror suppressionparam callable $controller The controller to handle the request
     * // // // @error suppressionerror suppressionerror suppressionparam string $vmInstanceId The VM instance ID parameter name
     * // // // @error suppressionerror suppressionerror suppressionparam array $methods The HTTP methods allowed for this route (default: ['GET'])
     * // // // @error suppressionerror suppressionerror suppressionparam Rate|null $rateLimit Optional default rate limit for this route (e.g., Rate::perMinute(60))
     *                             Admin can override this in ratelimit.json
     * // // // @error suppressionerror suppressionerror suppressionparam string|null $rateLimitNamespace Optional default namespace for rate limiting (default: 'rate_limit')
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam RouteCollection $routes The Symfony RouteCollection instance to add the route to
     * // // // @error suppressionerror suppressionerror suppressionparam string $name The name of the route
     * // // // @error suppressionerror suppressionerror suppressionparam string $path The URL path for the route (e.g. '/api/public/data')
     * // // // @error suppressionerror suppressionerror suppressionparam callable $controller The controller to handle the request
     * // // // @error suppressionerror suppressionerror suppressionparam array $methods The HTTP methods allowed for this route (default: ['GET'])
     * // // // @error suppressionerror suppressionerror suppressionparam Rate|null $rateLimit Optional default rate limit for this route (e.g., Rate::perMinute(60))
     *                             Admin can override this in ratelimit.json
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam RouteCollection $routes The Symfony RouteCollection instance to add the route to
     * // // // @error suppressionerror suppressionerror suppressionparam string $name The name of the route
     * // // // @error suppressionerror suppressionerror suppressionparam string $path The URL path for the route (e.g. '/api/wings/data')
     * // // // @error suppressionerror suppressionerror suppressionparam callable $controller The controller to handle the request
     * // // // @error suppressionerror suppressionerror suppressionparam array $methods The HTTP methods allowed for this route (default: ['GET'])
     * // // // @error suppressionerror suppressionerror suppressionparam Rate|null $rateLimit Optional default rate limit for this route (e.g., Rate::perMinute(60))
     *                             Admin can override this in ratelimit.json
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $key The key of the environment variable
     * // // // @error suppressionerror suppressionerror suppressionparam string $value The value of the environment variable
     * // // // @error suppressionerror suppressionerror suppressionparam bool $encode If the value should be encoded
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn bool If the value was updated
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionthrows RandomException
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn \Redis|null The Redis connection or null if not available
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn null Always returns null as rate limiters are created per-route
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam callable $controller The controller to handle the request
     * // // // @error suppressionerror suppressionerror suppressionparam Permissions|string $permission The permission node required to access this route
     * // // // @error suppressionerror suppressionerror suppressionparam Rate|null $rateLimit The rate limit for this route (e.g., Rate::perMinute(60))
     * // // // @error suppressionerror suppressionerror suppressionparam array $methods The HTTP methods allowed for this route (default: ['GET'])
     * // // // @error suppressionerror suppressionerror suppressionparam string|null $rateLimitNamespace Optional namespace for rate limiting (default: 'rate_limit')
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam RouteCollection $routes The Symfony RouteCollection instance to add the route to
     * // // // @error suppressionerror suppressionerror suppressionparam string $name The name of the route
     * // // // @error suppressionerror suppressionerror suppressionparam string $path The URL path for the route
     * // // // @error suppressionerror suppressionerror suppressionparam callable $controller The controller to handle the request
     * // // // @error suppressionerror suppressionerror suppressionparam array $middleware Array of middleware class names
     * // // // @error suppressionerror suppressionerror suppressionparam array $methods The HTTP methods allowed for this route (default: ['GET'])
     * // // // @error suppressionerror suppressionerror suppressionparam Rate|null $rateLimit The rate limit for this route (e.g., Rate::perMinute(60))
     * // // // @error suppressionerror suppressionerror suppressionparam string|null $rateLimitNamespace Optional namespace for rate limiting (default: 'rate_limit')
     * // // // @error suppressionerror suppressionerror suppressionparam string|null $rateLimitIdentifier Optional custom identifier for rate limiting (default: client IP)
     * // // // @error suppressionerror suppressionerror suppressionparam array $routeAttributes Additional route attributes (e.g., '_permission', '_server')
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $routeName The route name
     * // // // @error suppressionerror suppressionerror suppressionparam Rate|null $defaultRate The default rate limit from developer (used for auto-population only)
     * // // // @error suppressionerror suppressionerror suppressionparam string|null $defaultNamespace The default namespace
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array|null Returns ['rate' => Rate, 'namespace' => string] or null if no rate limit configured
     */
