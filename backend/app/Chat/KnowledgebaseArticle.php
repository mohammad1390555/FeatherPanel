...
class KnowledgebaseArticle
{
     ...
     * // @error suppressionparam string $search Search term
     * // @error suppressionparam int|null $categoryId Filter by category ID
     * // @error suppressionparam string|null $status Filter by status
     * // @error suppressionparam bool|null $pinned Filter by pinned status
     *
     * // @error suppressionreturn array Array of articles
     */
     ...
     * Get article by ID.
     *
     * // @error suppressionparam int $id Article ID
     *
     * // @error suppressionreturn array|null Article data or null if not found
     */
     ...
     * Get article by slug.
     *
     * // @error suppressionparam string $slug Article slug
     *
     * // @error suppressionreturn array|null Article data or null if not found
     */
     ...
     *
     * // @error suppressionparam int $categoryId Category ID
     ...
     *
     * // @error suppressionparam int $authorId Author ID
     * // @error suppressionparam int $limit Number of records
     *
     * // @error suppressionreturn array Array of articles
     */
     ...
     * // @error suppressionparam bool|null $pinned Filter by pinned status
     *
     * // @error suppressionreturn int Count of articles
     */
     ...
     *
     * // @error suppressionparam array $data Article data
     *
     * // @error suppressionreturn int|false The new article's ID or false on failure
     */
     ...
     *
     * // @error suppressionparam array $articles Array of ['id' => int, 'sort_order' => int]
     *
     * // @error suppressionreturn bool True on success, false on failure
     */
