...
{
    /**
     * // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionvar string The VM instance backups table name
     */
    ...
    public static function getBackupsByInstanceId(int $vmInstanceId): array
    {
        ...
        /** // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionvar array<int, array<string, mixed>> $rows */
