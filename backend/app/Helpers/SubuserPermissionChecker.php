...
class SubuserPermissionChecker
{
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $permission The permission to check (e.g., 'file.read', 'backup.create')
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool True if the user has the permission, false otherwise
     */
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $userId The user ID
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $serverId The server ID
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $permissions Array of permissions to check
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool True if the user has at least one of the permissions
     */
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $permissions Array of permissions to check
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool True if the user has all of the permissions
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $controller The controller name (e.g., 'files', 'backups', 'databases')
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $action The action name (e.g., 'list', 'create', 'update', 'delete')
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn string|null The required permission, or null if not mapped
     */
