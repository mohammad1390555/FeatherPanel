...
{
    /**
     * // @error suppressionvar string The tasks table name
     */
     ...
     * Create a new task.
     *
     * // @error suppressionparam array $data Associative array of task fields
     *
     * // @error suppressionreturn int|false The new task's ID or false on failure
     */
     ...
     * // @error suppressionparam string $search Search term for action or payload (optional)
     * // @error suppressionparam array $fields Fields to select (e.g. ['action', 'is_queued']) (default: all)
     ...
     * // @error suppressionparam int|null $scheduleId Filter by schedule ID (optional)
     * // @error suppressionparam string|null $action Filter by action type (optional)
     * // @error suppressionparam bool|null $isQueued Filter by queued status (optional)
     */
