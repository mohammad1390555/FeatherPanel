...
class UserAnalytics
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Statistics including total, active, banned, verified, and 2FA enabled users
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Role distribution with counts and percentages
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $days Number of days to look back (default: 30)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Daily registration counts
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $limit Number of top users to retrieve (default: 10)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Top users with server counts
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $hours Number of hours to look back (default: 24)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Activity summary
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Complete dashboard statistics
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $limit Number of recent banned users to retrieve (default: 20)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Banned users statistics
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Security metrics
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Growth rate metrics
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $days Number of days to look back (default: 7)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Daily activity counts
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $limit Number of top activities to retrieve (default: 10)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Top activities with counts
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Activity distribution
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $limit Number of recent activities to retrieve (default: 20)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Recent activities
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Activity statistics
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam int $days Number of days to look back (default: 7)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Hourly activity distribution
     */
