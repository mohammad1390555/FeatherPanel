...
class PluginWidgetController
{
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $component Original component URL
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam Request $request HTTP request
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn string Enhanced component URL with query parameters
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam mixed $size Size configuration from widget definition
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn string|array<string, int>
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array<string, mixed> $widget
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array<string, int>|null
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array<string, string>|null
     */
