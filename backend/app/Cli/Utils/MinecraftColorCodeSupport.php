...
class MinecraftColorCodeSupport
{
     ...
     *
     * // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $message The message to send
     *
     * // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn string The message to send
     */
    ...
    public static function sendOutputWithNewLine(string $message, bool $stripColors = false, bool $stripClean = false): void
    {
        ...
        if ($stripClean) {
            ...
            $translatedMessage = preg_replace('/[^a-zA-Z0-9\s\.\,\_\-\!\?\:\;\// // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppression\#\$\%\^\&\*\(\)\[\]\{\}\<\>\=\+\/\\\\\|\~\`\'\"\§]/u', '', $translatedMessage);
        }
     ...
     *
     * // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $message The message to get
     *
     * // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn string The message to get
     */
