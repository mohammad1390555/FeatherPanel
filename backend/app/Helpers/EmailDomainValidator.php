...
final class EmailDomainValidator
{
    ...
    /** // // @error suppressionerror suppressionvar array<string, true>|null */
    ...
    /**
     * // // @error suppressionerror suppressionparam array<string, true> $blockedFlip
     */
    ...
    public static function extractDomain(string $email): ?string
    {
        ...
        $at = strrpos($email, '// // @error suppressionerror suppression');
        if ($at === false) {
            return null;
        }
