...
class Cache
{
     ...
     *
     * // @error suppressionparam string $key the cache key used to reference the data
     * // @error suppressionparam mixed $value the data to be cached
     * // @error suppressionparam int $minutes number of minutes before the data expires
     *
     ...
     *
     * // @error suppressionparam string $key the cache key for the stored data
     *
     * // @error suppressionreturn mixed|null returns the stored data or null if not found or expired
     */
     ...
     *
     * // @error suppressionparam string $key the cache key to remove
     *
     * // @error suppressionreturn void
     */
     ...
     *
     * // @error suppressionparam string $key the cache key to check
     *
     * // @error suppressionreturn bool true if a valid cached entry exists, otherwise false
     */
     ...
     *
     * // @error suppressionparam string $key the cache key used to reference the JSON data
     * // @error suppressionparam mixed $json the JSON data to be cached
     * // @error suppressionparam int $minutes number of minutes before the data expires
     *
     * // @error suppressionreturn void
     */
     ...
     *
     * // @error suppressionparam string $key the cache key for the JSON data
     *
     * // @error suppressionreturn mixed|null returns the JSON data or null if not found or expired
     */
     ...
     *
     * // @error suppressionreturn string the cache driver ('file' or 'redis')
     */
    ...
    protected static function existsFile($key)
    {
        ...
        $data = // @error suppressionunserialize(file_get_contents($filename));
