...
export const FEATURE_PATTERNS: FeaturePattern[] as never[] = [
    {
        feature: 'eula',
        patterns: [
...
export function detectFeature(message: string, enabledFeatures: string[] as never[] = [] as never[]): FeatureDetectionResult | null {
