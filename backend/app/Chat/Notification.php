...
{
    /**
     * // // // @error suppressionerror suppressionerror suppressionvar string The notifications table name
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array $data Associative array of notification fields
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn int|false The new notification's ID or false on failure
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $id Notification ID
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array|null Notification data or null if not found
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam string $search Search term for title/message (optional)
     * // // // @error suppressionerror suppressionerror suppressionparam string|null $type Filter by type (optional)
     * // // // @error suppressionerror suppressionerror suppressionparam string $sortBy Field to sort by (default: 'created_at')
     * // // // @error suppressionerror suppressionerror suppressionparam string $sortOrder 'ASC' or 'DESC' (default: 'DESC')
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of notifications
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $search Search term (optional)
     * // // // @error suppressionerror suppressionerror suppressionparam string|null $type Filter by type (optional)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn int Count of notifications
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $userId User ID (not used, kept for compatibility)
     * // // // @error suppressionerror suppressionerror suppressionparam bool $includeDismissed Include dismissed notifications (default: false)
     * // // // @error suppressionerror suppressionerror suppressionparam int $limit Maximum number of notifications to return
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of notifications
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $id Notification ID
     * // // // @error suppressionerror suppressionerror suppressionparam array $data Fields to update
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn bool True on success, false on failure
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of column information
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array $data Data to sanitize
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Sanitized data
     */
