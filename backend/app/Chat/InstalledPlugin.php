...
class InstalledPlugin
{
     ...
     *
     * // @error suppressionparam array $data Associative array of plugin fields
     *
     * // @error suppressionreturn int|false The new record's ID or false on failure
     */
     ...
     *
     * // @error suppressionparam string $identifier Plugin identifier
     *
     * // @error suppressionreturn array|null Plugin data or null if not found
     */
     ...
     *
     * // @error suppressionparam int $id Plugin record ID
     *
     * // @error suppressionreturn array|null Plugin data or null if not found
     */
     ...
     *
     * // @error suppressionreturn array Array of installed plugins
     */
     ...
     *
     * // @error suppressionreturn array Array of all plugin records
     */
     ...
     *
     * // @error suppressionreturn array Array of uninstalled plugins
     */
     ...
     *
     * // @error suppressionreturn int Count of installed plugins
     */
     ...
     *
     * // @error suppressionreturn int Count of uninstalled plugins
     */
