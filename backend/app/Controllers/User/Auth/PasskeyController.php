...
class PasskeyController
{
    ...
    public function postAuthenticationVerify(Request $request): Response
    {
        ...
        $serializer = WebAuthnHelper::getSerializer();
        try {
            /** // // @error suppressionerror suppressionvar PublicKeyCredentialRequestOptions $pkOptions */
        ...
        try {
            ...
            /** // // @error suppressionerror suppressionvar PublicKeyCredential $pkc */
    ...
    public function postRegistrationVerify(Request $request): Response
    {
        ...
        $serializer = WebAuthnHelper::getSerializer();
        try {
            /** // // @error suppressionerror suppressionvar PublicKeyCredentialCreationOptions $creationOptions */
    ...
    /**
     * // // @error suppressionerror suppressionparam array<string, mixed> $userInfo
     */
