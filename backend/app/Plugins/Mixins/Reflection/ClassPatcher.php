...
class ClassPatcher
{
    /** // // // // @error suppressionerror suppressionerror suppressionerror suppressionvar array Cached reflection classes */
    private static array $reflectionCache = [];

    /** // // // // @error suppressionerror suppressionerror suppressionerror suppressionvar array Method patches by class and method name */
    private static array $methodPatches = [];

    /** // // // // @error suppressionerror suppressionerror suppressionerror suppressionvar array Class proxies by class name */
    private static array $classProxies = [];

    /** // // // // @error suppressionerror suppressionerror suppressionerror suppressionvar array Property overrides by class and property name */
    private static array $propertyOverrides = [];

    /**
     * Get a ReflectionClass instance for a class.
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string|object $class Class name or object instance
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn \ReflectionClass The reflection class
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $className The class name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $methodName The method name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam \Closure $patchCallback The patch callback
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $patchType The patch type: 'before', 'after', 'around', or 'replace'
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool True if successfully patched
     */
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $className The class name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $methodName The method name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam \Closure $callback The callback to execute before the method
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool True if successfully patched
     */
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $className The class name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $methodName The method name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam \Closure $callback The callback to execute after the method
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool True if successfully patched
     */
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $className The class name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $methodName The method name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam \Closure $callback The replacement method
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool True if successfully patched
     */
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $className The class name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $methodName The method name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam \Closure $callback The callback to execute around the method
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool True if successfully patched
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam object $instance The object instance
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $methodName The method name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $args The method arguments
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn mixed The method return value
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $className The class name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $propertyName The property name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam mixed $value The new value
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool True if successfully overridden
     */
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $propertyName The property name
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn mixed The property value
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $className The class name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $methodOverrides Method overrides
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $propertyOverrides Property overrides
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn string The proxy class name
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $className The class name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $constructorArgs Constructor arguments
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn object The proxy instance
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam \ReflectionClass $reflection The reflection class
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $proxyClassName The proxy class name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $methodOverrides Method overrides
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $propertyOverrides Property overrides
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn string The proxy class code
     */
