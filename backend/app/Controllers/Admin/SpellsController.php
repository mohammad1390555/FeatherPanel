...
class SpellsController
{
    ...
    public function onlineInstall(Request $request): Response
    {
        try {
            ...
            $storeResp = // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionfile_get_contents($storeUrl, false, $context);
            if ($storeResp === false) {
