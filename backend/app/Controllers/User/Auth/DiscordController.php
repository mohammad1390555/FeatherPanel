...
class DiscordController
{
    ...
    public function callback(Request $request): RedirectResponse
    {
        ...
        $userUrl = 'https://discord.com/api/users/// // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionme';
