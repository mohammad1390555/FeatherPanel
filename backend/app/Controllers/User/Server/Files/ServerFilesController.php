...
class ServerFilesController
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array $node The node configuration array
     * // // // @error suppressionerror suppressionerror suppressionparam int $timeout Timeout in seconds (default: 30 seconds)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn Wings The Wings connection instance
     */
    ...
    /**
     * // // // @error suppressionerror suppressionerror suppressionreturn array{max_size_bytes: int, retention_days: int}
     */
