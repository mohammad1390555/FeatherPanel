 ...
 */
export function parseActionCommands(text: string): ActionCommand[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] {
    const commands: ActionCommand[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] = [] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
