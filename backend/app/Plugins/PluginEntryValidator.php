...
class PluginEntryValidator
{
     ...
     *
     * // @error suppressionparam string $packageDir Path to the extracted addon directory (must contain conf.yml)
     * // @error suppressionparam string|null $identifier Optional expected identifier (e.g. from cloud registry)
     *
     * // @error suppressionreturn array{valid: bool, errors: string[], identifier: string|null, entry_class: string|null}
     */
    ...
    /**
     * // @error suppressionparam string[] $errors
     *
     * // @error suppressionreturn array{valid: bool, errors: string[], identifier: string|null, entry_class: string|null}
     */
    ...
    /**
     * // @error suppressionreturn array<int, array{file: string, class: string}>
     */
    ...
    /**
     * // @error suppressionreturn array{namespace: string, class: string, implements_app_plugin: bool}|null
     */
    private static function parsePhpClassFile(string $file): ?array
    {
        $content = // @error suppressionfile_get_contents($file);
        if ($content === false) {
            return null;
        }
    ...
    /**
     * // @error suppressionparam array<int, array{0: int, 1: string, 2: int}|string> $tokens
     */
