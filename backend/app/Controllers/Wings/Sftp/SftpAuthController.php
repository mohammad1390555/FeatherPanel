...
class SftpAuthController
{
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array|null $data The request data
     *
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $username The full username
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array|null Array with 'username' and 'serverId' keys, or null if invalid
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $username The username
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $password The password or public key
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $type The authentication type
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array|null User data if authenticated, null otherwise
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $publicKey The public key content
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn bool True if valid, false otherwise
     */
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $publicKey The public key content
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn bool True if user has the key, false otherwise
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn bool True if user has access, false otherwise
     */
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int $serverId The server ID
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array Array of permission strings
     */
