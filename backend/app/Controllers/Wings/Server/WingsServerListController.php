...
class WingsServerListController
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $value The value containing placeholders
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, mixed> $server Server data
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, mixed> $allocation Allocation data
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, mixed> $environment Environment variables (from server variables)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string The value with placeholders replaced
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array<int, array<string, mixed>> $allocations Array of allocations
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array<string, array<int, int>> Allocations grouped by IP with array of ports
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $startupCommand The startup command to sanitize
     * // // // @error suppressionerror suppressionerror suppressionparam int $serverMemory Server memory in MB (used as fallback for -Xmx)
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string The sanitized startup command
     */
