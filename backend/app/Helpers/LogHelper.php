...
class LogHelper
{
     ...
     *
     * // @error suppressionparam string $type Log type ('web', 'app', etc.)
     *
     * // @error suppressionreturn string Full path to the log file
     */
     ...
     *
     * // @error suppressionparam string $type Log type ('web', 'app', 'mail', 'runner', …)
     *
     * // @error suppressionreturn string Full path to the (now-guaranteed) log file
     */
     ...
     *
     * // @error suppressionparam string $filePath Path to the log file
     * // @error suppressionparam int $lines Number of lines to read from the end
     *
     * // @error suppressionreturn string Content of the last N lines
     */
     ...
     *
     * // @error suppressionparam string $content Log content to upload
     *
     * // @error suppressionreturn array Upload result with 'success', 'url', 'raw', 'id' or 'error'
     */
     ...
     *
     * // @error suppressionparam string $filename The log filename
     *
     * // @error suppressionreturn string Log type ('web', 'app', or 'unknown')
     */
