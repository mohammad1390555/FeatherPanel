...
class VmInstanceActivity
{
     ...
     *
     * // @error suppressionparam array $data vm_instance_id, vm_node_id, event; optional: user_id, metadata, ip
     *
     ...
     *
     * // @error suppressionparam int $vmInstanceId VM instance ID
     ...
     *
     * // @error suppressionreturn array{data: array<int, array<string, mixed>>, pagination: array{current_page: int, per_page: int, total: int, last_page: int, from: int, to: int}}
     */
