...
class MailQueue
{
    ...
    /**
     * // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn int|bool New queue row id on success, true when SMTP is disabled (nothing queued), false on validation or DB failure
     */
