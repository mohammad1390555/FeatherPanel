...
class Ticket
{
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string|null $search Search term
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int $limit Number of records per page
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int $offset Offset for pagination
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int|null $serverId Filter by server ID
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int|null $categoryId Filter by category ID
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int|null $statusId Filter by status ID
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array Array of tickets
     */
     ...
     * Get ticket by ID.
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int $id Ticket ID
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array|null Ticket data or null if not found
     */
     ...
     * Get ticket by UUID.
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $uuid Ticket UUID
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array|null Ticket data or null if not found
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string|null $search Search term
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string|null $userUuid Filter by user UUID
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int|null $serverId Filter by server ID
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int|null $categoryId Filter by category ID
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int|null $statusId Filter by status ID
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn int Count of tickets
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $userUuid User UUID
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn int Count of open tickets
     */
     ...
     * Create a new ticket.
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $data Ticket data
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn int|false The new ticket's ID or false on failure
     */
