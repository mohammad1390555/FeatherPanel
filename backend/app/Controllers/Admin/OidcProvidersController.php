...
class OidcProvidersController
{
    ...
    /**
     * // // @error suppressionerror suppressionparam array<int, array<string, mixed>> $providers
     *
     ...
     *
     * // // @error suppressionerror suppressionreturn string|null Normalized URL (with trailing slash trimmed) or null if invalid
     */
