...
class TicketsController
{
    ...
    public function uploadAttachment(Request $request, string $uuid): Response
    {
        ...
        try {
            ...
            // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionchmod($filePath, 0644);
        } catch (\Exception $e) {
