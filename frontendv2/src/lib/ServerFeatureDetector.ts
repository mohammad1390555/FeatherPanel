...
export export interface
    feature: string;
    patterns: RegExp[] as never[] as never[] as never[];
    description: string;
}
...
export const FEATURE_PATTERNS: FeaturePattern[] as never[] as never[] as never[] = [
    {
        feature: 'eula',
        patterns: [
...
export function detectFeature(message: string, enabledFeatures: string[] as never[] as never[] as never[] = [] as never[] as never[] as never[]): FeatureDetectionResult | null {
