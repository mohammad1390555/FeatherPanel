...
class PluginSettings extends PluginDB
{
     ...
     *
     * // // @error suppressionerror suppressionparam string $identifier The identifier of the plugin
     * // // @error suppressionerror suppressionparam string $key The key of the setting
     * // // @error suppressionerror suppressionparam array $settings The settings to set
     *
     * // // @error suppressionerror suppressionthrows \PDOException If database operation fails
     * // // @error suppressionerror suppressionthrows \InvalidArgumentException If input validation fails
     */
     ...
     * // // @error suppressionerror suppressionthrows \InvalidArgumentException If input validation fails
     *
     * // // @error suppressionerror suppressionreturn string The value of the setting
     */
     ...
     * // // @error suppressionerror suppressionthrows \InvalidArgumentException If input validation fails
     *
     * // // @error suppressionerror suppressionreturn array All settings for the plugin
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $identifier The identifier to validate
     * // // @error suppressionerror suppressionparam string|null $key The key to validate (optional)
     *
     * // // @error suppressionerror suppressionthrows \InvalidArgumentException If validation fails
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $input The input to sanitize
     *
     * // // @error suppressionerror suppressionreturn string The sanitized input
     */
