...
interface AppPlugin
{
     ...
     *
     * // @error suppressionparam string|null $oldVersion The previous version of the plugin (e.g., "1.0.0")
     * // @error suppressionparam string|null $newVersion The new version being installed (e.g., "1.0.1")
     *
     * // @error suppressionexample
