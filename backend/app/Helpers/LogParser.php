...
class LogParser
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $gameType The game type identifier (e.g., 'minecraft', 'cs2')
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Associative array with keys 'join', 'leave', 'stop' containing regex patterns
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $line The log line to parse
     * // // // @error suppressionerror suppressionerror suppressionparam string $gameType The game type identifier
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array|null Returns ['event' => 'join'|'leave'|'stop', 'player' => '...'] or null if no match
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $serverUuid The server UUID used as the cache key identifier
     * // // // @error suppressionerror suppressionerror suppressionparam string $line The log line to process
     * // // // @error suppressionerror suppressionerror suppressionparam string $gameType The game type identifier
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array List of player names currently online
     */
