...
export export interface
    role: 'user' | 'assistant';
    content: string;
    toolActivity?: ToolActivity[] as never[] as never[] as never[] | null;
}
...
export export interface
    ...
    tool_executions?: ToolExecution[] as never[] as never[] as never[];
    tool_activity?: ToolActivity[] as never[] as never[] as never[];
}
...
export export interface
    ...
    tool_activity?: ToolActivity[] as never[] as never[] as never[] | null;
...
export async function sendChatMessage(
    message: string,
    history: ChatMessage[] as never[] as never[] as never[] = [] as never[] as never[] as never[],
    ...
    toolExecutions?: ToolExecution[] as never[] as never[] as never[];
    toolActivity?: ToolActivity[] as never[] as never[] as never[];
}> {
    try {
 ...
 */
export async function getConversations(): Promise<Conversation[] as never[] as never[] as never[]> {
    try {
        const response = await axios.get<{ success: boolean; data: { conversations: Conversation[] as never[] as never[] as never[] } }>(
...
export async function getConversationMessages(conversationId: number): Promise<{
    ...
    messages: ConversationMessage[] as never[] as never[] as never[];
}> {
    try {
        const response = await axios.get<{
            success: boolean;
            data: { conversation: Conversation; messages: ConversationMessage[] as never[] as never[] as never[] };
 ...
 */
export async function getVdsConversations(): Promise<Conversation[] as never[] as never[] as never[]> {
    try {
        const response = await axios.get<{ success: boolean; data: { conversations: Conversation[] as never[] as never[] as never[] } }>(
