...
class WingsTransferStatusController
{
     ...
     *
     * // // @error suppressionerror suppressionparam array $server The server data
     * // // @error suppressionerror suppressionparam array $transfer The transfer record
     * // // @error suppressionerror suppressionparam mixed $logger The logger instance
     */
