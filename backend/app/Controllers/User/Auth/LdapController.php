...
class LdapController
{
    ...
    private function provisionUser(array $ldapUser, array $provider): ?array
    {
        ...
        try {
            ...
            $username = $ldapUser['username'] ?? explode('// // // // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppression', $ldapUser['email'])[0];
