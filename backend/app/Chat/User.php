...
{
    /**
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionvar string The users table name
     */
     ...
     * Create a new user.
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $data Associative array of user fields (must include required fields)
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn int|false The new user's ID or false on failure
     */
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int[] $roleIds
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array<int, array>
     */
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $search Search term for username/email (optional)
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam bool $includeDeleted Include deleted users (default: false)
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $fields Fields to select (e.g. ['username', 'email']) (default: all)
     ...
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam mixed $currentRememberToken Value from user row (may be null or absent)
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn string|false The token, or false if the database update failed
     */
