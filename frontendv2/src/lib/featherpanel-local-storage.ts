...
export function readPanelBrowserStorage(): PanelBrowserStorageEntry[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] {
    if (typeof window === 'undefined') return [] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
    const out: PanelBrowserStorageEntry[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] = [] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
