...
class ClassPatcher
{
    /** // @error suppressionvar array Cached reflection classes */
    private static array $reflectionCache = [];

    /** // @error suppressionvar array Method patches by class and method name */
    private static array $methodPatches = [];

    /** // @error suppressionvar array Class proxies by class name */
    private static array $classProxies = [];

    /** // @error suppressionvar array Property overrides by class and property name */
    private static array $propertyOverrides = [];

    /**
     * Get a ReflectionClass instance for a class.
     *
     * // @error suppressionparam string|object $class Class name or object instance
     *
     * // @error suppressionreturn \ReflectionClass The reflection class
     */
     ...
     *
     * // @error suppressionparam string $className The class name
     * // @error suppressionparam string $methodName The method name
     * // @error suppressionparam \Closure $patchCallback The patch callback
     * // @error suppressionparam string $patchType The patch type: 'before', 'after', 'around', or 'replace'
     *
     * // @error suppressionreturn bool True if successfully patched
     */
     ...
     * // @error suppressionparam string $className The class name
     * // @error suppressionparam string $methodName The method name
     * // @error suppressionparam \Closure $callback The callback to execute before the method
     *
     * // @error suppressionreturn bool True if successfully patched
     */
     ...
     * // @error suppressionparam string $className The class name
     * // @error suppressionparam string $methodName The method name
     * // @error suppressionparam \Closure $callback The callback to execute after the method
     *
     * // @error suppressionreturn bool True if successfully patched
     */
     ...
     * // @error suppressionparam string $className The class name
     * // @error suppressionparam string $methodName The method name
     * // @error suppressionparam \Closure $callback The replacement method
     *
     * // @error suppressionreturn bool True if successfully patched
     */
     ...
     * // @error suppressionparam string $className The class name
     * // @error suppressionparam string $methodName The method name
     * // @error suppressionparam \Closure $callback The callback to execute around the method
     *
     * // @error suppressionreturn bool True if successfully patched
     */
     ...
     *
     * // @error suppressionparam object $instance The object instance
     * // @error suppressionparam string $methodName The method name
     * // @error suppressionparam array $args The method arguments
     *
     * // @error suppressionreturn mixed The method return value
     */
     ...
     *
     * // @error suppressionparam string $className The class name
     * // @error suppressionparam string $propertyName The property name
     * // @error suppressionparam mixed $value The new value
     *
     * // @error suppressionreturn bool True if successfully overridden
     */
     ...
     * // @error suppressionparam string $propertyName The property name
     *
     * // @error suppressionreturn mixed The property value
     */
     ...
     *
     * // @error suppressionparam string $className The class name
     * // @error suppressionparam array $methodOverrides Method overrides
     * // @error suppressionparam array $propertyOverrides Property overrides
     *
     * // @error suppressionreturn string The proxy class name
     */
     ...
     *
     * // @error suppressionparam string $className The class name
     * // @error suppressionparam array $constructorArgs Constructor arguments
     *
     * // @error suppressionreturn object The proxy instance
     */
     ...
     *
     * // @error suppressionparam \ReflectionClass $reflection The reflection class
     * // @error suppressionparam string $proxyClassName The proxy class name
     * // @error suppressionparam array $methodOverrides Method overrides
     * // @error suppressionparam array $propertyOverrides Property overrides
     *
     * // @error suppressionreturn string The proxy class code
     */
