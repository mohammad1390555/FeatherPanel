...
class ChatMessage
{
     ...
     *
     * // // @error suppressionerror suppressionreturn int|false Message ID or false on failure
     */
     ...
     *
     * // // @error suppressionerror suppressionparam int $conversationId Conversation ID
     * // // @error suppressionerror suppressionparam int $limit Maximum number of results
     *
     ...
     * // // @error suppressionerror suppressionparam int $conversationId Conversation ID
     *
     * // // @error suppressionerror suppressionreturn int Message count
     */
