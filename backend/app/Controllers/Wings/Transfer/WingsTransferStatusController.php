...
class WingsTransferStatusController
{
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $server The server data
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $transfer The transfer record
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam mixed $logger The logger instance
     */
