...
class TicketMessage
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $ticketId Ticket ID
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of messages
     */
     ...
     * Get message by ID.
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $id Message ID
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array|null Message data or null if not found
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam int $ticketId Ticket ID
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn int Count of messages
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array{unread_count:int,has_unread:bool}
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array $data Message data
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn int|false The new message's ID or false on failure
     */
