...
class MountsController
{
    ...
    /**
     * // // @error suppressionerror suppressionparam 'node'|'spell'|'server' $type
     */
    ...
    /**
     * // // @error suppressionerror suppressionparam array<mixed> $items Per API item in the request body array
     *
