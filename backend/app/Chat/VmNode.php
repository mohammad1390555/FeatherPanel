...
{
    /**
     * // // @error suppressionerror suppressionvar string The VM nodes table name
     */
     ...
     *
     * // // @error suppressionerror suppressionvar array<int, string>
     */
     ...
     * // // @error suppressionerror suppressionparam array<int, string> $requiredFields
     *
     * // // @error suppressionerror suppressionreturn array<int, string> Validation error messages (empty if ok)
     */
     ...
     * // // @error suppressionerror suppressionparam array<string, mixed> $data
     *
     * // // @error suppressionerror suppressionreturn int|false The new VM node ID or false on failure
     */
     ...
     *
     * // // @error suppressionerror suppressionparam array<string, mixed> $conditions
     */
     ...
     *
     * // // @error suppressionerror suppressionparam array<string, mixed> $row
     *
     * // // @error suppressionerror suppressionreturn array<string, mixed>
     */
