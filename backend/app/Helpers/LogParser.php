...
class LogParser
{
     ...
     *
     * // @error suppressionparam string $gameType The game type identifier (e.g., 'minecraft', 'cs2')
     *
     * // @error suppressionreturn array Associative array with keys 'join', 'leave', 'stop' containing regex patterns
     */
     ...
     *
     * // @error suppressionparam string $line The log line to parse
     * // @error suppressionparam string $gameType The game type identifier
     *
     * // @error suppressionreturn array|null Returns ['event' => 'join'|'leave'|'stop', 'player' => '...'] or null if no match
     */
     ...
     *
     * // @error suppressionparam string $serverUuid The server UUID used as the cache key identifier
     * // @error suppressionparam string $line The log line to process
     * // @error suppressionparam string $gameType The game type identifier
     */
     ...
     *
     * // @error suppressionreturn array List of player names currently online
     */
