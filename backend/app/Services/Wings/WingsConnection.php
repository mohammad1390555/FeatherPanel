...
class WingsConnection
{
     ...
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $host The Wings server hostname/IP
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int $port The Wings server port (default: 8443)
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $protocol The protocol to use (http/https)
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $authToken The authentication token for Wings
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int $timeout Request timeout in seconds (default: 30)
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam bool $behindProxy Whether Wings is accessed through a reverse proxy
     */
     ...
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $endpoint The API endpoint (without base URL)
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $headers Additional headers to include
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int $maxRetries Maximum number of retry attempts
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows WingsConnectionException
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows WingsAuthenticationException
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows WingsRequestException
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array The response data
     */
     ...
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows WingsRequestException
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn string The raw response body
     */
     ...
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $endpoint The API endpoint (without base URL)
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $data The data to send
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $headers Additional headers to include
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int $maxRetries Maximum number of retry attempts
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int|null $timeout Optional timeout in seconds (overrides default timeout)
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows WingsConnectionException
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows WingsAuthenticationException
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows WingsRequestException
     ...
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $endpoint The API endpoint (without base URL)
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $body Raw request body
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $headers Additional headers to include
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int $maxRetries Maximum number of retry attempts
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows WingsConnectionException
     ...
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows WingsRequestException
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array Decoded JSON response if any, otherwise empty array
     */
     ...
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $method The HTTP method
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $endpoint The API endpoint (without base URL)
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $data The data to send (for POST, PUT, PATCH)
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $headers Additional headers to include
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int $maxRetries Maximum number of retry attempts (default: 3)
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int|null $timeout Optional timeout in seconds (overrides default timeout)
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows WingsConnectionException
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows WingsAuthenticationException
     ...
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam bool $detailed Whether to get detailed information (v2)
     */
