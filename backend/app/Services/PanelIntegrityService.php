...
class PanelIntegrityService
{
    ...
    /**
     * // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam list<array{path: string, sha256: string, bytes: int}> $files
     *
     * // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows \RuntimeException
     */
    ...
    /**
     * // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array{present: bool, created_at: ?string, panel_version: ?string, files: ?array<string, string>}
     */
    private function loadBaselineMeta(): array
    {
        ...
        /** // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionvar array<string, string> $fileMap */
        $fileMap = [];
    ...
    /**
     * // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam list<array{path: string, sha256: string, bytes: int}> $scanned
     * // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam ?array<string, string> $baseline
     *
     * // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn ?array{
     *   matches: int,
     *   modified: list<array{path: string, expected: string, actual: string}>,
