...
class DatabaseManagmentController
{
    ...
    /**
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, string> $directories
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array<int, array{namespace: string, path: string, name: string}>
     */
