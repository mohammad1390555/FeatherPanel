...
class PlayerStatusService
{
     ...
     *
     * // @error suppressionparam array $server Server array with keys: uuid_short, uuid, name, status, ip, port, spell, realm, node_fqdn, node_public_ip
     *
     * // @error suppressionreturn array|null Player status data or null if the server is unsupported
     */
     ...
     *
     * // @error suppressionparam string $uuidShort The server's short UUID
     *
     * // @error suppressionreturn array|null Cached player status data or null if unavailable
     */
     ...
     *
     * // @error suppressionparam int|null $configured The configured polling interval in seconds, or null for default
     *
     * // @error suppressionreturn int Effective polling interval in seconds
     */
     ...
     * // @error suppressionparam string $uuidShort The server's short UUID
     *
     * // @error suppressionreturn string Cache key in the format `player_status:{uuidShort}`
     */
     ...
     *
     * // @error suppressionparam int $pollingInterval The effective polling interval in seconds
     *
     * // @error suppressionreturn int Cache TTL in minutes
     */
     ...
     * // @error suppressionparam string $uuidShort The server's short UUID
     *
     * // @error suppressionreturn array|null Server data array or null if not found
     */
     ...
     *
     * // @error suppressionparam string $allocationIp The allocation IP from the database
     * // @error suppressionparam array $server The server data array (may contain node_fqdn, node_public_ip)
     *
     * // @error suppressionreturn string The resolved IP/hostname to query
     */
