...
export export interface
    ...
    mount_ids: number[] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
}
...
export export interface
    allocations: Allocation[] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
    server: {
