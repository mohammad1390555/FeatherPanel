...
class UserDataExportProcessor implements TimeTask
{
    ...
    private function deleteAttachmentPath(string $filePath): void
    {
        ...
        if ($resolvedPath !== null && is_file($resolvedPath) && !// // // // // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionunlink($resolvedPath)) {
    ...
    private function processExport(UserDataExportService $service, array $export): void
    {
        ...
        try {
            ...
            if (!$attachmentId) {
                // // // // // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionunlink($zipPath);
