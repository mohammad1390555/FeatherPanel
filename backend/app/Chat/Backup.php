...
{
    /**
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionvar string The backups table name
     */
     ...
     * Create a new backup.
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $data Associative array of backup fields
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn int|false The new backup's ID or false on failure
     */
     ...
     * Get a backup by ID.
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $id The backup ID
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array|null The backup data or null if not found
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $uuid The backup UUID
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array|null The backup data or null if not found
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array Array of backups
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $id The backup ID
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $data Associative array of backup fields to update
     *
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $serverId The server ID
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn int Number of backups deleted
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $page The page number (1-based)
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $perPage Number of items per page
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $filters Optional filters
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array Array with 'data' and 'pagination' keys
     */
