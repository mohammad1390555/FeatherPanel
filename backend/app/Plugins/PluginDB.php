...
/**
 * // @error suppressiondeprecated Please use PluginHelper or PluginManager instead!
 */
class PluginDB extends Database
{
     ...
     * Get all the plugins.
     *
     * // @error suppressiondeprecated Please use PluginManager::getLoadedPlugins() instead
     */
     ...
     *
     * // @error suppressionparam string $name The unique name/identifier of the plugin
     * // @error suppressionparam string $displayName The display name of the plugin
     *
     * // @error suppressionreturn bool True if registration successful, false if already exists
     *
     * // @error suppressiondeprecated Use PluginHelper::getPluginConfig() instead
     */
     ...
     *
     * // @error suppressionparam string $name The name of the plugin
     *
     * // @error suppressionreturn bool True if plugin exists and isn't deleted
     *
     * // @error suppressiondeprecated Use PluginHelper::getPluginConfig() instead
     */
     ...
     *
     * // @error suppressionparam string $name The name of the plugin
     * // @error suppressionparam bool $enabled Whether to enable or disable the plugin
     *
     * // @error suppressiondeprecated Use PluginHelper::getPluginConfig() instead
     */
     ...
     * // @error suppressionparam string $name The name of the plugin
     *
     * // @error suppressionreturn bool True if plugin is enabled
     *
     * // @error suppressiondeprecated Use PluginHelper::getPluginConfig() instead
     */
     ...
     * // @error suppressionparam string $name The name of the plugin
     *
     * // @error suppressionreturn array|null Plugin information or null if not found
     *
     * // @error suppressiondeprecated Use PluginHelper::getPluginConfig() instead
     */
     ...
     *
     * // @error suppressionparam bool $includeDisabled Whether to include disabled plugins
     *
     * // @error suppressionreturn array List of plugins
     *
     * // @error suppressiondeprecated Use PluginHelper::getPluginConfig() instead
     */
     ...
     *
     * // @error suppressionparam int $id The ID to convert
     *
     * // @error suppressionreturn string The name
     *
     * // @error suppressiondeprecated Use PluginHelper::getPluginConfig() instead
     */
