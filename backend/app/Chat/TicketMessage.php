...
class TicketMessage
{
     ...
     *
     * // // @error suppressionerror suppressionparam int $ticketId Ticket ID
     ...
     *
     * // // @error suppressionerror suppressionreturn array Array of messages
     */
     ...
     * Get message by ID.
     *
     * // // @error suppressionerror suppressionparam int $id Message ID
     *
     * // // @error suppressionerror suppressionreturn array|null Message data or null if not found
     */
     ...
     * // // @error suppressionerror suppressionparam int $ticketId Ticket ID
     *
     * // // @error suppressionerror suppressionreturn int Count of messages
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn array{unread_count:int,has_unread:bool}
     */
     ...
     *
     * // // @error suppressionerror suppressionparam array $data Message data
     *
     * // // @error suppressionerror suppressionreturn int|false The new message's ID or false on failure
     */
