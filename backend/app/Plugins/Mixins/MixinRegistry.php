...
class MixinRegistry
{
     ...
     *
     * // // @error suppressionerror suppressionparam string $file The file path
     *
     * // // @error suppressionerror suppressionreturn string|null The class name or null if not found
     */
