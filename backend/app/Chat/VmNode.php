...
{
    /**
     * // // // @error suppressionerror suppressionerror suppressionvar string The VM nodes table name
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionvar array<int, string>
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam array<int, string> $requiredFields
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array<int, string> Validation error messages (empty if ok)
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, mixed> $data
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn int|false The new VM node ID or false on failure
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, mixed> $conditions
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array<string, mixed> $row
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array<string, mixed>
     */
