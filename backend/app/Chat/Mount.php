...
class Mount
{
    ...
    /** // // // @error suppressionerror suppressionerror suppressionvar string[] Disallowed host source paths */
    ...
    /** // // // @error suppressionerror suppressionerror suppressionvar string[] Disallowed container targets (default data mount is reserved). */
    ...
    /**
     * // // // @error suppressionerror suppressionerror suppressionreturn array{error: ?string, source: string, target: string}
     */
    ...
    /**
     * // // // @error suppressionerror suppressionerror suppressionparam array{name:string,description?:?string,source:string,target:string,read_only?:bool,user_mountable?:bool} $data omit user_mountable for default true (Pelican admin create always enables this)
     */
    ...
    /**
     * // // // @error suppressionerror suppressionerror suppressionparam array{name?:string,description?:?string,source?:string,target?:string,read_only?:bool|int,user_mountable?:bool|int} $data
     */
    ...
    /**
     * // // // @error suppressionerror suppressionerror suppressionreturn int[]
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int[] $entityIds node IDs, spell IDs, or server IDs depending on $type
     */
    ...
    /**
     * // // // @error suppressionerror suppressionerror suppressionreturn list<array{source:string,target:string,read_only:bool}>
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam ?int $spellIdOverride When set (e.g. draft spell in admin UI), filter by this spell instead of the server's stored spell_id.
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array<int, array<string, mixed>>
     */
    ...
    /**
     * // // // @error suppressionerror suppressionerror suppressionparam int[] $mountIds
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int[] $nodeIds
     * // // // @error suppressionerror suppressionerror suppressionparam int[] $spellIds integer IDs (>0) after validation
     */
