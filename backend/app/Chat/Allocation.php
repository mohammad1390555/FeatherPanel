...
class Allocation
{
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array<int> $excludeIds Allocation IDs to skip (already reserved in the same batch)
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array<int>
     */
    /**
     * Pick free allocation IDs that match specific IP/port slots (in order).
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array<int, array{ip: string, port: int}> $slots
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array<int> $excludeIds
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array<int>
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $allocationIds Array of allocation IDs to unassign
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool True if all allocations were unassigned successfully
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $serverId The server ID to assign allocations to
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $allocationIds Array of allocation IDs to assign
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool True if all allocations were assigned successfully
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $id Allocation ID
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool True if allocation can be deleted
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $ids Array of allocation IDs to delete
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array ['deleted' => count, 'skipped' => count, 'skipped_ids' => []]
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int|null $nodeId Optional node ID to filter deletions
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string|null $ip Optional IP address to filter deletions by subnet/IP
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn int Number of allocations deleted
     */
