...
class MixinRegistry
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $file The file path
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string|null The class name or null if not found
     */
