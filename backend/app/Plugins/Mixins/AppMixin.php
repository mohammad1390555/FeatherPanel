...
interface AppMixin
{
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $pluginIdentifier The identifier of the plugin using this mixin
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn string The mixin identifier
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn string The mixin version
     */
