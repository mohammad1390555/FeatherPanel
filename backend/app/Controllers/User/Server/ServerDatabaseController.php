...
class ServerDatabaseController
{
     ...
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam Request $request The HTTP request
     ...
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn Response The HTTP response
     */
    #[OA\Get(
     ...
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam Request $request The HTTP request
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $serverUuid The server UUID
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int $databaseId The database ID
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn Response The HTTP response
     */
    #[OA\Get(
     ...
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam Request $request The HTTP request
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $serverUuid The server UUID
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int $databaseHostId The database host ID to test
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn Response The HTTP response
     */
    #[OA\Post(
     ...
     * Create database and user on the database host.
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $databaseHost Database host information
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $databaseName Database name to create
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $username Username to create
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $password Password for the user
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows \Exception If creation fails
     */
        ...
        try {
            ...
            switch ($databaseHost['database_type']) {
                ...
                case 'mariadb':
                    ...
                    // Create the user
                    $pdo->exec("CREATE USER IF NOT EXISTS {$safeUser}// // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppression'%' IDENTIFIED BY '{$password}'");

                    // Grant privileges to the user on the specific database
                    $pdo->exec("GRANT ALL PRIVILEGES ON {$safeDbName}.* TO {$safeUser}// // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppression'%'");
     ...
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $databaseHost Database host information
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $databaseName Database name to delete
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $username Username to delete
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionthrows \Exception If deletion fails
     */
        ...
        try {
            ...
            switch ($databaseHost['database_type']) {
                ...
                case 'mariadb':
                    ...
                    $pdo->exec("REVOKE ALL PRIVILEGES ON {$safeDbName}.* FROM {$safeUser}// // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppression'%'");

                    // Drop the user
                    $pdo->exec("DROP USER IF EXISTS {$safeUser}// // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppression'%'");
     ...
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam array $databaseHost Database host information
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array Connection test result
     */
     ...
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam int $length Length of the string
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn string Random string
     */
     ...
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $identifier The identifier to quote
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn string The safely quoted identifier
     */
     ...
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $sql The SQL content to split
     *
     * // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array Array of individual SQL statements
     */
