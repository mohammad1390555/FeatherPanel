...
class Ticket
{
     ...
     * // // @error suppressionerror suppressionparam int|null $serverId Filter by server ID
     * // // @error suppressionerror suppressionparam int|null $categoryId Filter by category ID
     * // // @error suppressionerror suppressionparam int|null $statusId Filter by status ID
     *
     * // // @error suppressionerror suppressionreturn array Array of tickets
     */
     ...
     * Get ticket by ID.
     *
     * // // @error suppressionerror suppressionparam int $id Ticket ID
     *
     * // // @error suppressionerror suppressionreturn array|null Ticket data or null if not found
     */
     ...
     * Get ticket by UUID.
     *
     * // // @error suppressionerror suppressionparam string $uuid Ticket UUID
     *
     * // // @error suppressionerror suppressionreturn array|null Ticket data or null if not found
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string|null $search Search term
     * // // @error suppressionerror suppressionparam string|null $userUuid Filter by user UUID
     * // // @error suppressionerror suppressionparam int|null $serverId Filter by server ID
     * // // @error suppressionerror suppressionparam int|null $categoryId Filter by category ID
     * // // @error suppressionerror suppressionparam int|null $statusId Filter by status ID
     *
     * // // @error suppressionerror suppressionreturn int Count of tickets
     */
     ...
     *
     * // // @error suppressionerror suppressionreturn int Count of open tickets
     */
     ...
     * Create a new ticket.
     *
     * // // @error suppressionerror suppressionparam array $data Ticket data
     *
     * // // @error suppressionerror suppressionreturn int|false The new ticket's ID or false on failure
     */
