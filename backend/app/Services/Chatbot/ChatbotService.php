...
class ChatbotService
{
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam array $pageContext Optional page context (route, server, etc.)
     *
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam ToolHandler $toolHandler Tool handler instance
     *
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn ProviderInterface|null Provider instance or null if invalid
     */
