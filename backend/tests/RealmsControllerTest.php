...
class RealmsControllerTest extends TestCase
{
    ...
    public function testCreateAndDeleteRealm()
    {
        ...
        $payload = [
            ...
            'author' => 'testadmin// // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionexample.com',
        ];
