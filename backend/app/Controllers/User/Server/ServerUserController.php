...
class ServerUserController
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn Response The API response
     */
    #[OA\Post(
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam string $uuidShort The server's short UUID
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn Response The update response
     */
    #[OA\Put(
        path: '/api/user/servers/{uuidShort}',
    ...
    private function validateVariableValue(string $value, string $rules, string $fieldType = ''): ?string
    {
        ...
        foreach ($parts as $part) {
            ...
            if (str_starts_with($part, 'regex:')) {
                ...
                $isValid = // // // @error suppressionerror suppressionerror suppressionpreg_match($normalizedPattern, '') !== false;
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array The user's permissions
     */
