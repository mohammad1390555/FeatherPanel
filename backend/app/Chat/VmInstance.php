...
class VmInstance
{
     ...
     *
     * // // @error suppressionerror suppressionreturn array<int, mixed>
     */
    ...
    /**
     * // // @error suppressionerror suppressionparam \PDO|null $pdo Optional connection (e.g. when inside a transaction)
     */
