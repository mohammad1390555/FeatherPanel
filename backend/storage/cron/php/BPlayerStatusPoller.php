...
class BPlayerStatusPoller implements TimeTask
{
     ...
     *
     * // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn array Array of server rows with joined data
     */
