...
class PluginConfig
{
     ...
     *
     * // @error suppressionreturn array Optional fields with their types
     */
     ...
     *
     * // @error suppressionreturn bool If the plugin identifier is valid
     */
     ...
     * Check if the plugin config is valid.
     *
     * // @error suppressionparam array $config The plugin config
     *
     * // @error suppressionreturn bool If the plugin config is valid
     */
     ...
     * // @error suppressionparam string $identifier The plugin identifier
     *
     * // @error suppressionreturn array The mixins configuration
     */
     ...
     * // @error suppressionparam string $identifier The plugin identifier
     *
     * // @error suppressionreturn array The required config fields with their specifications
     */
     ...
     *
     * // @error suppressionparam array $configDef The config field definition
     * // @error suppressionparam mixed $value The value to validate
     *
     * // @error suppressionreturn bool Whether the value is valid
     */
     ...
     *
     * // @error suppressionparam string $identifier The plugin identifier
     * // @error suppressionparam array $providedConfig The configuration to validate
     *
     * // @error suppressionreturn array Array with validation result and errors if any
     */
     ...
     * // @error suppressionparam string $identifier The plugin identifier
     *
     * // @error suppressionreturn array The default configuration values
     */
     ...
     * // @error suppressionparam string $identifier The plugin identifier
     *
     * // @error suppressionreturn string|int|null The plugin cloud ID or null if not set
     */
     ...
     * // @error suppressionparam string $identifier The plugin identifier
     *
     * // @error suppressionreturn string|null The minimum panel version or null if not set
     */
     ...
     * // @error suppressionparam string $identifier The plugin identifier
     *
     * // @error suppressionreturn string|null The maximum panel version or null if not set
     */
     ...
     *
     * // @error suppressionreturn string The current panel version
     */
     ...
     * // @error suppressionparam string $identifier The plugin identifier
     *
     * // @error suppressionreturn array Array with 'compatible' boolean and 'message' string
     */
     ...
     *
     * // @error suppressionparam array $config The plugin config
     * // @error suppressionparam string $pluginIdentifier The plugin identifier
     *
     * // @error suppressionreturn bool True if valid, false otherwise
     */
     ...
     *
     * // @error suppressionparam mixed $value The value to validate
     * // @error suppressionparam string $type The expected type
     *
     * // @error suppressionreturn bool True if valid, false otherwise
     */
     ...
     *
     * // @error suppressionparam string $version The version string
     *
     * // @error suppressionreturn bool True if valid format, false otherwise
     */
     ...
     *
     * // @error suppressionparam array $mixins The mixins configuration
     * // @error suppressionparam string $pluginIdentifier The plugin identifier
     *
     * // @error suppressionreturn bool True if valid, false otherwise
     */
