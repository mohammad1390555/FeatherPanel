...
class App extends Utils\MinecraftColorCodeSupport
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $commandName the name of the command to register
     * // // // @error suppressionerror suppressionerror suppressionparam array $args The command arguments
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam array $args The command arguments
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn bool WhethregisterBuiltInCommandser a plugin command was found and executed
     */
