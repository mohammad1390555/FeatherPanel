...
class KnowledgebaseArticleTag
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $articleId Article ID
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of tags
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $tagName Tag name
     * // // // @error suppressionerror suppressionerror suppressionparam int $limit Number of records
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of article IDs
     */
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam int $limit Number of records
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of tag names
     */
     ...
     * Get tag by ID.
     *
     * // // // @error suppressionerror suppressionerror suppressionparam int $id Tag ID
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array|null Tag data or null if not found
     */
     ...
     * Create a new tag.
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array $data Tag data
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn int|false The new tag's ID or false on failure
     */
