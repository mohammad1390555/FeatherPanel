...
class DashboardController
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $upstream The upstream type (stable/beta/canary)
     * // // // @error suppressionerror suppressionerror suppressionparam string $currentVersion The current application version
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Version information
     */
    private function fetchVersionInfo(
        ...
        try {
            ...
            $currentVersionResponse = // // // @error suppressionerror suppressionerror suppressionfile_get_contents(
                $currentVersionUrl,
                false,
                $context,
            );
            ...
            $latestVersionResponse = // // // @error suppressionerror suppressionerror suppressionfile_get_contents(
                $latestVersionUrl,
                false,
                $context,
            );
