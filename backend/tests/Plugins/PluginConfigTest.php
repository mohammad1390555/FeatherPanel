...
class PluginConfigTest extends TestCase
{
    ...
    public function testIsValidIdentifierReturnsFalseForInvalidIdentifier()
    {
        ...
        $this->assertFalse(PluginConfig::isValidIdentifier('plugin// // // // // // // // // // // // // // // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionspecial'));
    }
