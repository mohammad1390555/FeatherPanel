...
class IpAddressMatcher
{
    ...
    /**
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn string|null Error message, or null if valid
     */
    ...
    public static function matchesRule(string $clientIp, string $rule): bool
    {
        ...
        $a = // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressioninet_pton($clientIp);
        $b = // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressioninet_pton($rule);
