...
class ContextBuilder
{
     ...
     * // // // @error suppressionerror suppressionerror suppressionparam array $pageContext Current page context (route, server, etc.)
     * // // // @error suppressionerror suppressionerror suppressionparam bool $includeLogs Whether server logs should be included in context
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string Formatted context string
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string System prompt content
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Array of server data
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam array $server Server data
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array|string Server logs or empty array/string
     */
