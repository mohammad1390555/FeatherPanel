...
class CloudFlareRealIP
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string Real client IP address
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array Debug information
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $ip IP address to validate
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn bool True if valid and not private/local
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn bool True if we should trust proxy headers
     */
