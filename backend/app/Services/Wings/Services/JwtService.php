...
class JwtService
{
     ...
     *
     * // @error suppressionparam string $nodeSecret The Wings node's secret key
     ...
     * // @error suppressionparam int $expiration Token expiration time in seconds (default: 600 = 10 minutes)
     */
     ...
     * // @error suppressionparam array $permissions The user's permissions
     * // @error suppressionparam string $action The specific action (start, stop, restart, etc.)
     *
     ...
     * // @error suppressionparam string $userUuid The user UUID
     * // @error suppressionparam array $permissions The user's permissions
     * // @error suppressionparam string $operation The file operation (read, write, delete, upload, download)
     * // @error suppressionparam string $filePath The file path (if applicable)
     *
     * // @error suppressionthrows \Exception
     *
     * // @error suppressionreturn string The JWT token
     ...
     * // @error suppressionparam string $userUuid The user UUID
     * // @error suppressionparam array $permissions The user's permissions
     * // @error suppressionparam string $operation The Docker operation (rebuild, logs, etc.)
     *
     * // @error suppressionthrows \Exception
     *
     * // @error suppressionreturn string The JWT token
     ...
     * // @error suppressionparam string $userUuid The user UUID
     * // @error suppressionparam array $permissions The user's permissions
     * // @error suppressionparam string $operation The system operation (logs, resources, etc.)
     *
     * // @error suppressionthrows \Exception
     *
     * // @error suppressionreturn string The JWT token
     ...
     *
     * // @error suppressionparam string $token The JWT token to validate
     *
     * // @error suppressionthrows \Exception
     *
     * // @error suppressionreturn array The decoded token payload
     */
     ...
     *
     * // @error suppressionparam string $token The JWT token to check
     *
     ...
     *
     * // @error suppressionparam string $serverUuid The destination server UUID (used as subject)
     * // @error suppressionparam string $userUuid The user UUID initiating the transfer
     * // @error suppressionparam array $permissions The user's permissions
     *
     * // @error suppressionthrows \Exception
     *
