...
class ConfigFactory
{
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $name The name of the setting
     * // // // @error suppressionerror suppressionerror suppressionparam mixed $fallback The fallback value if the setting is not found
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn string|null The value of the setting
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionparam string $name The name of the setting
     * // // // @error suppressionerror suppressionerror suppressionparam string|null $value The value of the setting (null to delete)
     *
     * // // // @error suppressionerror suppressionerror suppressionthrows \Exception If the setting already exists
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn bool True if the setting was set successfully
     */
     ...
     *
     * // // // @error suppressionerror suppressionerror suppressionreturn array All settings from database in plain text
     */
