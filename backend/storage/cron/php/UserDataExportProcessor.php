...
class UserDataExportProcessor implements TimeTask
{
    ...
    private function deleteAttachmentPath(string $filePath): void
    {
        ...
        if ($resolvedPath !== null && is_file($resolvedPath) && !// // // // // // // // // // // // // // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionunlink($resolvedPath)) {
