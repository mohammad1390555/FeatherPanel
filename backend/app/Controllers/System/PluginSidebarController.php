...
class PluginSidebarController
{
     ...
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionparam string $section Section type (server, client, admin)
     *
     * // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionreturn string Enhanced component URL with placeholders
     */
