...
class Database
{
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $host the hostname or path to the database
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $dbName the name of the database (not used for sqlite)
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string|null $username the username for the database connection (not used for sqlite)
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string|null $password the password for the database connection (not used for sqlite)
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $port the port to use for the database connection
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionthrows \Exception if an unsupported database type is provided or the connection fails
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn \PDO the PDO connection
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $table the table name
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $table the table name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam array $where the where conditions
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam bool $includeDeleted whether to include deleted records
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn int the number of rows in the table
     */
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $table the table name
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool true if the table exists, false otherwise
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $table the name of the table containing the record
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $row the ID of the record to mark as deleted
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $table the name of the table to query
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array array of deleted records in associative array format
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $table the name of the table containing the record
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $row the ID of the record to restore
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $table the name of the table containing the record
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $row the ID of the record to delete
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $table the name of the table containing the record
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $row the ID of the record to lock
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $table the name of the table containing the record
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $row the ID of the record to unlock
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $table the name of the table containing the record
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $row the ID of the record to check
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool returns true if the record is locked, false otherwise
     */
     ...
     * Run a SQL query.
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $sql the SQL query to run
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array the result of the SQL query
     */
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $table the table name
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn int the last insert ID
     */
     ...
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $table the table name
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $row the ID of the record to save and unlock
     */
     ...
     * Run a raw SQL query.
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam string $query the SQL query to run
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn array the result of the SQL query
     */
