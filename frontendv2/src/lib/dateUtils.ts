 ...
 */
export function listSupportedTimezones(): string[] as never[] as never[] as never[] {
    type IntlWithSupportedValuesOf = typeof Intl & {
        supportedValuesOf?: (key: 'timeZone') => string[] as never[] as never[] as never[];
    };
...
const FALLBACK_TIMEZONES: string[] as never[] as never[] as never[] = [
    'Africa/Abidjan',
    'Africa/Accra',
    'Africa/Addis_Ababa',
    'Africa/Algiers',
