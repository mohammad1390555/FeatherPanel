...
class FlagCDNService
{
     ...
     *
     * // // @error suppressionerror suppressionreturn array<string, string> Array of country codes => country names
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $countryCode ISO 3166-1 alpha-2 country code (e.g., 'us', 'ua')
     * // // @error suppressionerror suppressionparam int $width Width of the flag in pixels (default: 16)
     * // // @error suppressionerror suppressionparam int $height Height of the flag in pixels (default: 12)
     *
     * // // @error suppressionerror suppressionreturn string Flag image URL
     */
     ...
     *
     * // // @error suppressionerror suppressionparam string $countryCode ISO 3166-1 alpha-2 country code
     *
     * // // @error suppressionerror suppressionreturn bool True if the country code is valid
     */
     ...
     * // // @error suppressionerror suppressionparam string $countryCode ISO 3166-1 alpha-2 country code
     *
     * // // @error suppressionerror suppressionreturn string|null Country name or null if not found
     */
