...
class ConfigService
{
     ...
     *
     * // @error suppressionreturn string The raw YAML configuration
     */
     ...
     * }
     *
     * // @error suppressionparam string $yamlContent The complete YAML configuration content
     * // @error suppressionparam bool $restart Whether to restart Wings after update (default: false)
     *
     ...
     * }
     *
     * // @error suppressionparam array $updates Associative array of config paths to values (e.g., ['api.port' => 8443])
     * // @error suppressionparam bool $restart Whether to restart Wings after update (default: false)
     *
     * // @error suppressionreturn array The response data
     */
     ...
     *
     * // @error suppressionreturn array The configuration schema
     */
