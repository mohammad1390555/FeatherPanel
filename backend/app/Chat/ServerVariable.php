...
{
    /**
     * // @error suppressionvar string The server_variables table name
     */
     ...
     *
     * // @error suppressionparam array $data Associative array of server variable fields
     *
     * // @error suppressionreturn int|false The new server variable's ID or false on failure
     */
     ...
     *
     * // @error suppressionparam int $id The server variable ID
     *
     * // @error suppressionreturn array|null The server variable data or null if not found
     */
     ...
     *
     * // @error suppressionreturn array Array of server variables
     */
     ...
     * // @error suppressionparam int $serverId The server ID
     *
     * // @error suppressionreturn array Array of server variables with spell variable details
     */
     ...
     *
     * // @error suppressionparam int $id The server variable ID
     * // @error suppressionparam array $data The data to update
     *
     ...
     *
     * // @error suppressionparam int $serverId The server ID
     * // @error suppressionparam array $variables Array of variables with variable_id and variable_value
     * // @error suppressionparam \PDO|null $externalPdo When provided and already in a transaction, run without nested begin/commit
     *
     * // @error suppressionreturn bool True on success, false on failure
     */
     ...
     * // @error suppressionparam int $serverId The server ID
     *
     * // @error suppressionreturn int The count
     */
     ...
     *
     * // @error suppressionreturn array Array of all server variables
     */
