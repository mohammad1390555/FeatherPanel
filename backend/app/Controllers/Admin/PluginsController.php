...
class PluginsController
{
    ...
    public function uploadInstallFromUrl(Request $request): Response
    {
        try {
            ...
            $fileContent = // // @error suppressionerror suppressionfile_get_contents($url, false, $context);
     ...
     *
     * // // @error suppressionerror suppressionreturn array<string> Array of exclusion patterns
     */
