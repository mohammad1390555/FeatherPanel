...
class SuspensionService
{
     ...
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam int $detectionsCount Number of detections found
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionparam Configuration $config Configuration instance
     *
     * // // // // @error suppressionerror suppressionerror suppressionerror suppressionreturn bool True if server was suspended, false otherwise
     */
                ...
                $eventManager->emit(
                    ...
                    [
                        ...
                        'suspended_by' => [
                            ...
                            'email' => 'system// // // // @error suppressionerror suppressionerror suppressionerror suppressionfeatherpanel',
                        ],
                    ]
                );
            }
