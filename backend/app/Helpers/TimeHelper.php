...
class TimeHelper
{
     ...
     * // // @error suppressionerror suppressionparam string[] $extraKeys additional datetime keys to normalise
     *
     ...
     *
     * // // @error suppressionerror suppressionparam array<int, array<string, mixed>> $rows
     * // // @error suppressionerror suppressionparam string[] $extraKeys
     *
