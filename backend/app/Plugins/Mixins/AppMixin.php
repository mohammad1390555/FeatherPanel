...
interface AppMixin
{
     ...
     *
     * // @error suppressionparam string $pluginIdentifier The identifier of the plugin using this mixin
     ...
     *
     * // @error suppressionreturn string The mixin identifier
     */
     ...
     *
     * // @error suppressionreturn string The mixin version
     */
